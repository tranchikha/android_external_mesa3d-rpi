                       ...
                       SpvCapability cap)
{
   ...
   case SpvCapabilityTensorsARM: return caps->TensorsARM;
   case SpvCapabilityStorageTensorArrayDynamicIndexingARM: return caps->StorageTensorArrayDynamicIndexingARM;
   case SpvCapabilityStorageTensorArrayNonUniformIndexingARM: return caps->StorageTensorArrayNonUniformIndexingARM;
   case SpvCapabilityGraphARM: return caps->GraphARM;
   case SpvCapabilityCooperativeMatrixLayoutsARM: return caps->CooperativeMatrixLayoutsARM;
   case SpvCapabilityFloat8EXT: return caps->Float8EXT;
   case SpvCapabilityFloat8CooperativeMatrixEXT: return caps->Float8CooperativeMatrixEXT;
   ...
   case SpvCapabilityTileShadingQCOM: return caps->TileShadingQCOM;
   case SpvCapabilityCooperativeMatrixConversionQCOM: return caps->CooperativeMatrixConversionQCOM;
   ...
   case SpvCapabilityInt4TypeINTEL: return caps->Int4TypeINTEL;
   case SpvCapabilityInt4CooperativeMatrixINTEL: return caps->Int4CooperativeMatrixINTEL;
   ...
   case SpvCapabilityAbortKHR: return caps->AbortKHR;
   ...
   case SpvCapabilityGroupNonUniformPartitionedEXT: return caps->GroupNonUniformPartitionedEXT;
   ...
   case SpvCapabilityPushConstantBanksNV: return caps->PushConstantBanksNV;
   case SpvCapabilityLongVectorEXT: return caps->LongVectorEXT;
   case SpvCapabilityShader64BitIndexingEXT: return caps->Shader64BitIndexingEXT;
   ...
   case SpvCapabilityFPGAMemoryAttributesALTERA: return caps->FPGAMemoryAttributesALTERA;
   case SpvCapabilityFPFastMathModeINTEL: return caps->FPFastMathModeINTEL;
   case SpvCapabilityArbitraryPrecisionIntegersALTERA: return caps->ArbitraryPrecisionIntegersALTERA;
   case SpvCapabilityArbitraryPrecisionFloatingPointALTERA: return caps->ArbitraryPrecisionFloatingPointALTERA;
   case SpvCapabilityUnstructuredLoopControlsINTEL: return caps->UnstructuredLoopControlsINTEL;
   case SpvCapabilityFPGALoopControlsALTERA: return caps->FPGALoopControlsALTERA;
   ...
   case SpvCapabilityFPGAMemoryAccessesALTERA: return caps->FPGAMemoryAccessesALTERA;
   case SpvCapabilityFPGAClusterAttributesALTERA: return caps->FPGAClusterAttributesALTERA;
   case SpvCapabilityLoopFuseALTERA: return caps->LoopFuseALTERA;
   case SpvCapabilityFPGADSPControlALTERA: return caps->FPGADSPControlALTERA;
   case SpvCapabilityMemoryAccessAliasingINTEL: return caps->MemoryAccessAliasingINTEL;
   case SpvCapabilityFPGAInvocationPipeliningAttributesALTERA: return caps->FPGAInvocationPipeliningAttributesALTERA;
   case SpvCapabilityFPGABufferLocationALTERA: return caps->FPGABufferLocationALTERA;
   case SpvCapabilityArbitraryPrecisionFixedPointALTERA: return caps->ArbitraryPrecisionFixedPointALTERA;
   case SpvCapabilityUSMStorageClassesALTERA: return caps->USMStorageClassesALTERA;
   case SpvCapabilityRuntimeAlignedAttributeALTERA: return caps->RuntimeAlignedAttributeALTERA;
   case SpvCapabilityIOPipesALTERA: return caps->IOPipesALTERA;
   case SpvCapabilityBlockingPipesALTERA: return caps->BlockingPipesALTERA;
   case SpvCapabilityFPGARegALTERA: return caps->FPGARegALTERA;
   ...
   case SpvCapabilityTaskSequenceALTERA: return caps->TaskSequenceALTERA;
   case SpvCapabilityFPMaxErrorINTEL: return caps->FPMaxErrorINTEL;
   case SpvCapabilityFPGALatencyControlALTERA: return caps->FPGALatencyControlALTERA;
   case SpvCapabilityFPGAArgumentInterfacesALTERA: return caps->FPGAArgumentInterfacesALTERA;
   case SpvCapabilityGlobalVariableHostAccessINTEL: return caps->GlobalVariableHostAccessINTEL;
   case SpvCapabilityGlobalVariableFPGADecorationsALTERA: return caps->GlobalVariableFPGADecorationsALTERA;
   ...
   case SpvCapabilityTernaryBitwiseFunctionINTEL: return caps->TernaryBitwiseFunctionINTEL;
   ...
   case SpvCapabilityBindlessImagesINTEL: return caps->BindlessImagesINTEL;
   case SpvCapabilityDotProductFloat16AccFloat32VALVE: return caps->DotProductFloat16AccFloat32VALVE;
   case SpvCapabilityDotProductFloat16AccFloat16VALVE: return caps->DotProductFloat16AccFloat16VALVE;
   case SpvCapabilityDotProductBFloat16AccVALVE: return caps->DotProductBFloat16AccVALVE;
   case SpvCapabilityDotProductFloat8AccFloat32VALVE: return caps->DotProductFloat8AccFloat32VALVE;
   default:
      return false;
   }
}
                       ...
                       SpvCapability cap, bool enabled)
{
   ...
   case SpvCapabilityTensorsARM: caps->TensorsARM = enabled; break;
   case SpvCapabilityStorageTensorArrayDynamicIndexingARM: caps->StorageTensorArrayDynamicIndexingARM = enabled; break;
   case SpvCapabilityStorageTensorArrayNonUniformIndexingARM: caps->StorageTensorArrayNonUniformIndexingARM = enabled; break;
   case SpvCapabilityGraphARM: caps->GraphARM = enabled; break;
   case SpvCapabilityCooperativeMatrixLayoutsARM: caps->CooperativeMatrixLayoutsARM = enabled; break;
   case SpvCapabilityFloat8EXT: caps->Float8EXT = enabled; break;
   case SpvCapabilityFloat8CooperativeMatrixEXT: caps->Float8CooperativeMatrixEXT = enabled; break;
   ...
   case SpvCapabilityTileShadingQCOM: caps->TileShadingQCOM = enabled; break;
   case SpvCapabilityCooperativeMatrixConversionQCOM: caps->CooperativeMatrixConversionQCOM = enabled; break;
   ...
   case SpvCapabilityInt4TypeINTEL: caps->Int4TypeINTEL = enabled; break;
   case SpvCapabilityInt4CooperativeMatrixINTEL: caps->Int4CooperativeMatrixINTEL = enabled; break;
   ...
   case SpvCapabilityAbortKHR: caps->AbortKHR = enabled; break;
   ...
   case SpvCapabilityGroupNonUniformPartitionedEXT: caps->GroupNonUniformPartitionedEXT = enabled; break;
   ...
   case SpvCapabilityPushConstantBanksNV: caps->PushConstantBanksNV = enabled; break;
   case SpvCapabilityLongVectorEXT: caps->LongVectorEXT = enabled; break;
   case SpvCapabilityShader64BitIndexingEXT: caps->Shader64BitIndexingEXT = enabled; break;
   ...
   case SpvCapabilityFPGAMemoryAttributesALTERA: caps->FPGAMemoryAttributesALTERA = enabled; break;
   case SpvCapabilityFPFastMathModeINTEL: caps->FPFastMathModeINTEL = enabled; break;
   case SpvCapabilityArbitraryPrecisionIntegersALTERA: caps->ArbitraryPrecisionIntegersALTERA = enabled; break;
   case SpvCapabilityArbitraryPrecisionFloatingPointALTERA: caps->ArbitraryPrecisionFloatingPointALTERA = enabled; break;
   case SpvCapabilityUnstructuredLoopControlsINTEL: caps->UnstructuredLoopControlsINTEL = enabled; break;
   case SpvCapabilityFPGALoopControlsALTERA: caps->FPGALoopControlsALTERA = enabled; break;
   ...
   case SpvCapabilityFPGAMemoryAccessesALTERA: caps->FPGAMemoryAccessesALTERA = enabled; break;
   case SpvCapabilityFPGAClusterAttributesALTERA: caps->FPGAClusterAttributesALTERA = enabled; break;
   case SpvCapabilityLoopFuseALTERA: caps->LoopFuseALTERA = enabled; break;
   case SpvCapabilityFPGADSPControlALTERA: caps->FPGADSPControlALTERA = enabled; break;
   case SpvCapabilityMemoryAccessAliasingINTEL: caps->MemoryAccessAliasingINTEL = enabled; break;
   case SpvCapabilityFPGAInvocationPipeliningAttributesALTERA: caps->FPGAInvocationPipeliningAttributesALTERA = enabled; break;
   case SpvCapabilityFPGABufferLocationALTERA: caps->FPGABufferLocationALTERA = enabled; break;
   case SpvCapabilityArbitraryPrecisionFixedPointALTERA: caps->ArbitraryPrecisionFixedPointALTERA = enabled; break;
   case SpvCapabilityUSMStorageClassesALTERA: caps->USMStorageClassesALTERA = enabled; break;
   case SpvCapabilityRuntimeAlignedAttributeALTERA: caps->RuntimeAlignedAttributeALTERA = enabled; break;
   case SpvCapabilityIOPipesALTERA: caps->IOPipesALTERA = enabled; break;
   case SpvCapabilityBlockingPipesALTERA: caps->BlockingPipesALTERA = enabled; break;
   case SpvCapabilityFPGARegALTERA: caps->FPGARegALTERA = enabled; break;
   ...
   case SpvCapabilityTaskSequenceALTERA: caps->TaskSequenceALTERA = enabled; break;
   case SpvCapabilityFPMaxErrorINTEL: caps->FPMaxErrorINTEL = enabled; break;
   case SpvCapabilityFPGALatencyControlALTERA: caps->FPGALatencyControlALTERA = enabled; break;
   case SpvCapabilityFPGAArgumentInterfacesALTERA: caps->FPGAArgumentInterfacesALTERA = enabled; break;
   case SpvCapabilityGlobalVariableHostAccessINTEL: caps->GlobalVariableHostAccessINTEL = enabled; break;
   case SpvCapabilityGlobalVariableFPGADecorationsALTERA: caps->GlobalVariableFPGADecorationsALTERA = enabled; break;
   ...
   case SpvCapabilityTernaryBitwiseFunctionINTEL: caps->TernaryBitwiseFunctionINTEL = enabled; break;
   ...
   case SpvCapabilityBindlessImagesINTEL: caps->BindlessImagesINTEL = enabled; break;
   case SpvCapabilityDotProductFloat16AccFloat32VALVE: caps->DotProductFloat16AccFloat32VALVE = enabled; break;
   case SpvCapabilityDotProductFloat16AccFloat16VALVE: caps->DotProductFloat16AccFloat16VALVE = enabled; break;
   case SpvCapabilityDotProductBFloat16AccVALVE: caps->DotProductBFloat16AccVALVE = enabled; break;
   case SpvCapabilityDotProductFloat8AccFloat32VALVE: caps->DotProductFloat8AccFloat32VALVE = enabled; break;
   default:
...
spirv_builtin_to_string(SpvBuiltIn v)
{
   ...
   case SpvBuiltInTileOffsetQCOM: return "SpvBuiltInTileOffsetQCOM";
   case SpvBuiltInTileDimensionQCOM: return "SpvBuiltInTileDimensionQCOM";
   case SpvBuiltInTileApronSizeQCOM: return "SpvBuiltInTileApronSizeQCOM";
   ...
   case SpvBuiltInSamplerHeapEXT: return "SpvBuiltInSamplerHeapEXT";
   case SpvBuiltInResourceHeapEXT: return "SpvBuiltInResourceHeapEXT";
...
spirv_capability_to_string(SpvCapability v)
{
   ...
   case SpvCapabilityTensorsARM: return "SpvCapabilityTensorsARM";
   case SpvCapabilityStorageTensorArrayDynamicIndexingARM: return "SpvCapabilityStorageTensorArrayDynamicIndexingARM";
   case SpvCapabilityStorageTensorArrayNonUniformIndexingARM: return "SpvCapabilityStorageTensorArrayNonUniformIndexingARM";
   case SpvCapabilityGraphARM: return "SpvCapabilityGraphARM";
   case SpvCapabilityCooperativeMatrixLayoutsARM: return "SpvCapabilityCooperativeMatrixLayoutsARM";
   case SpvCapabilityFloat8EXT: return "SpvCapabilityFloat8EXT";
   case SpvCapabilityFloat8CooperativeMatrixEXT: return "SpvCapabilityFloat8CooperativeMatrixEXT";
   ...
   case SpvCapabilityTileShadingQCOM: return "SpvCapabilityTileShadingQCOM";
   case SpvCapabilityCooperativeMatrixConversionQCOM: return "SpvCapabilityCooperativeMatrixConversionQCOM";
   ...
   case SpvCapabilityInt4TypeINTEL: return "SpvCapabilityInt4TypeINTEL";
   case SpvCapabilityInt4CooperativeMatrixINTEL: return "SpvCapabilityInt4CooperativeMatrixINTEL";
   ...
   case SpvCapabilityAbortKHR: return "SpvCapabilityAbortKHR";
   ...
   case SpvCapabilityGroupNonUniformPartitionedEXT: return "SpvCapabilityGroupNonUniformPartitionedEXT";
   ...
   case SpvCapabilityPushConstantBanksNV: return "SpvCapabilityPushConstantBanksNV";
   case SpvCapabilityLongVectorEXT: return "SpvCapabilityLongVectorEXT";
   case SpvCapabilityShader64BitIndexingEXT: return "SpvCapabilityShader64BitIndexingEXT";
   ...
   case SpvCapabilityFPGAMemoryAttributesALTERA: return "SpvCapabilityFPGAMemoryAttributesALTERA";
   case SpvCapabilityFPFastMathModeINTEL: return "SpvCapabilityFPFastMathModeINTEL";
   case SpvCapabilityArbitraryPrecisionIntegersALTERA: return "SpvCapabilityArbitraryPrecisionIntegersALTERA";
   case SpvCapabilityArbitraryPrecisionFloatingPointALTERA: return "SpvCapabilityArbitraryPrecisionFloatingPointALTERA";
   case SpvCapabilityUnstructuredLoopControlsINTEL: return "SpvCapabilityUnstructuredLoopControlsINTEL";
   case SpvCapabilityFPGALoopControlsALTERA: return "SpvCapabilityFPGALoopControlsALTERA";
   ...
   case SpvCapabilityFPGAMemoryAccessesALTERA: return "SpvCapabilityFPGAMemoryAccessesALTERA";
   case SpvCapabilityFPGAClusterAttributesALTERA: return "SpvCapabilityFPGAClusterAttributesALTERA";
   case SpvCapabilityLoopFuseALTERA: return "SpvCapabilityLoopFuseALTERA";
   case SpvCapabilityFPGADSPControlALTERA: return "SpvCapabilityFPGADSPControlALTERA";
   case SpvCapabilityMemoryAccessAliasingINTEL: return "SpvCapabilityMemoryAccessAliasingINTEL";
   case SpvCapabilityFPGAInvocationPipeliningAttributesALTERA: return "SpvCapabilityFPGAInvocationPipeliningAttributesALTERA";
   case SpvCapabilityFPGABufferLocationALTERA: return "SpvCapabilityFPGABufferLocationALTERA";
   case SpvCapabilityArbitraryPrecisionFixedPointALTERA: return "SpvCapabilityArbitraryPrecisionFixedPointALTERA";
   case SpvCapabilityUSMStorageClassesALTERA: return "SpvCapabilityUSMStorageClassesALTERA";
   case SpvCapabilityRuntimeAlignedAttributeALTERA: return "SpvCapabilityRuntimeAlignedAttributeALTERA";
   case SpvCapabilityIOPipesALTERA: return "SpvCapabilityIOPipesALTERA";
   case SpvCapabilityBlockingPipesALTERA: return "SpvCapabilityBlockingPipesALTERA";
   case SpvCapabilityFPGARegALTERA: return "SpvCapabilityFPGARegALTERA";
   ...
   case SpvCapabilityTaskSequenceALTERA: return "SpvCapabilityTaskSequenceALTERA";
   case SpvCapabilityFPMaxErrorINTEL: return "SpvCapabilityFPMaxErrorINTEL";
   case SpvCapabilityFPGALatencyControlALTERA: return "SpvCapabilityFPGALatencyControlALTERA";
   case SpvCapabilityFPGAArgumentInterfacesALTERA: return "SpvCapabilityFPGAArgumentInterfacesALTERA";
   case SpvCapabilityGlobalVariableHostAccessINTEL: return "SpvCapabilityGlobalVariableHostAccessINTEL";
   case SpvCapabilityGlobalVariableFPGADecorationsALTERA: return "SpvCapabilityGlobalVariableFPGADecorationsALTERA";
   ...
   case SpvCapabilityTernaryBitwiseFunctionINTEL: return "SpvCapabilityTernaryBitwiseFunctionINTEL";
   ...
   case SpvCapabilityBindlessImagesINTEL: return "SpvCapabilityBindlessImagesINTEL";
   case SpvCapabilityDotProductFloat16AccFloat32VALVE: return "SpvCapabilityDotProductFloat16AccFloat32VALVE";
   case SpvCapabilityDotProductFloat16AccFloat16VALVE: return "SpvCapabilityDotProductFloat16AccFloat16VALVE";
   case SpvCapabilityDotProductBFloat16AccVALVE: return "SpvCapabilityDotProductBFloat16AccVALVE";
   case SpvCapabilityDotProductFloat8AccFloat32VALVE: return "SpvCapabilityDotProductFloat8AccFloat32VALVE";
...
spirv_decoration_to_string(SpvDecoration v)
{
   ...
   case SpvDecorationSaturatedToLargestFloat8NormalConversionEXT: return "SpvDecorationSaturatedToLargestFloat8NormalConversionEXT";
   ...
   case SpvDecorationArrayStrideIdEXT: return "SpvDecorationArrayStrideIdEXT";
   case SpvDecorationOffsetIdEXT: return "SpvDecorationOffsetIdEXT";
   case SpvDecorationUTFEncodedKHR: return "SpvDecorationUTFEncodedKHR";
   ...
   case SpvDecorationMemberOffsetNV: return "SpvDecorationMemberOffsetNV";
   case SpvDecorationHitObjectShaderRecordBufferNV: return "SpvDecorationHitObjectShaderRecordBufferNV";
   case SpvDecorationHitObjectShaderRecordBufferEXT: return "SpvDecorationHitObjectShaderRecordBufferEXT";
   case SpvDecorationBankNV: return "SpvDecorationBankNV";
   ...
   case SpvDecorationRegisterALTERA: return "SpvDecorationRegisterALTERA";
   case SpvDecorationMemoryALTERA: return "SpvDecorationMemoryALTERA";
   case SpvDecorationNumbanksALTERA: return "SpvDecorationNumbanksALTERA";
   case SpvDecorationBankwidthALTERA: return "SpvDecorationBankwidthALTERA";
   case SpvDecorationMaxPrivateCopiesALTERA: return "SpvDecorationMaxPrivateCopiesALTERA";
   case SpvDecorationSinglepumpALTERA: return "SpvDecorationSinglepumpALTERA";
   case SpvDecorationDoublepumpALTERA: return "SpvDecorationDoublepumpALTERA";
   case SpvDecorationMaxReplicatesALTERA: return "SpvDecorationMaxReplicatesALTERA";
   case SpvDecorationSimpleDualPortALTERA: return "SpvDecorationSimpleDualPortALTERA";
   case SpvDecorationMergeALTERA: return "SpvDecorationMergeALTERA";
   case SpvDecorationBankBitsALTERA: return "SpvDecorationBankBitsALTERA";
   case SpvDecorationForcePow2DepthALTERA: return "SpvDecorationForcePow2DepthALTERA";
   case SpvDecorationStridesizeALTERA: return "SpvDecorationStridesizeALTERA";
   case SpvDecorationWordsizeALTERA: return "SpvDecorationWordsizeALTERA";
   case SpvDecorationTrueDualPortALTERA: return "SpvDecorationTrueDualPortALTERA";
   case SpvDecorationBurstCoalesceALTERA: return "SpvDecorationBurstCoalesceALTERA";
   case SpvDecorationCacheSizeALTERA: return "SpvDecorationCacheSizeALTERA";
   case SpvDecorationDontStaticallyCoalesceALTERA: return "SpvDecorationDontStaticallyCoalesceALTERA";
   case SpvDecorationPrefetchALTERA: return "SpvDecorationPrefetchALTERA";
   case SpvDecorationStallEnableALTERA: return "SpvDecorationStallEnableALTERA";
   case SpvDecorationFuseLoopsInFunctionALTERA: return "SpvDecorationFuseLoopsInFunctionALTERA";
   case SpvDecorationMathOpDSPModeALTERA: return "SpvDecorationMathOpDSPModeALTERA";
   ...
   case SpvDecorationInitiationIntervalALTERA: return "SpvDecorationInitiationIntervalALTERA";
   case SpvDecorationMaxConcurrencyALTERA: return "SpvDecorationMaxConcurrencyALTERA";
   case SpvDecorationPipelineEnableALTERA: return "SpvDecorationPipelineEnableALTERA";
   case SpvDecorationBufferLocationALTERA: return "SpvDecorationBufferLocationALTERA";
   case SpvDecorationIOPipeStorageALTERA: return "SpvDecorationIOPipeStorageALTERA";
   ...
   case SpvDecorationStallFreeALTERA: return "SpvDecorationStallFreeALTERA";
   case SpvDecorationFPMaxErrorDecorationINTEL: return "SpvDecorationFPMaxErrorDecorationINTEL";
   case SpvDecorationLatencyControlLabelALTERA: return "SpvDecorationLatencyControlLabelALTERA";
   case SpvDecorationLatencyControlConstraintALTERA: return "SpvDecorationLatencyControlConstraintALTERA";
   case SpvDecorationConduitKernelArgumentALTERA: return "SpvDecorationConduitKernelArgumentALTERA";
   case SpvDecorationRegisterMapKernelArgumentALTERA: return "SpvDecorationRegisterMapKernelArgumentALTERA";
   case SpvDecorationMMHostInterfaceAddressWidthALTERA: return "SpvDecorationMMHostInterfaceAddressWidthALTERA";
   case SpvDecorationMMHostInterfaceDataWidthALTERA: return "SpvDecorationMMHostInterfaceDataWidthALTERA";
   case SpvDecorationMMHostInterfaceLatencyALTERA: return "SpvDecorationMMHostInterfaceLatencyALTERA";
   case SpvDecorationMMHostInterfaceReadWriteModeALTERA: return "SpvDecorationMMHostInterfaceReadWriteModeALTERA";
   case SpvDecorationMMHostInterfaceMaxBurstALTERA: return "SpvDecorationMMHostInterfaceMaxBurstALTERA";
   case SpvDecorationMMHostInterfaceWaitRequestALTERA: return "SpvDecorationMMHostInterfaceWaitRequestALTERA";
   case SpvDecorationStableKernelArgumentALTERA: return "SpvDecorationStableKernelArgumentALTERA";
   case SpvDecorationHostAccessINTEL: return "SpvDecorationHostAccessINTEL";
   case SpvDecorationInitModeALTERA: return "SpvDecorationInitModeALTERA";
   case SpvDecorationImplementInRegisterMapALTERA: return "SpvDecorationImplementInRegisterMapALTERA";
   case SpvDecorationConditionalINTEL: return "SpvDecorationConditionalINTEL";
...
spirv_executionmode_to_string(SpvExecutionMode v)
{
   ...
   case SpvExecutionModeNonCoherentTileAttachmentReadQCOM: return "SpvExecutionModeNonCoherentTileAttachmentReadQCOM";
   case SpvExecutionModeTileShadingRateQCOM: return "SpvExecutionModeTileShadingRateQCOM";
   ...
   case SpvExecutionModeArithmeticPoisonKHR: return "SpvExecutionModeArithmeticPoisonKHR";
   ...
   case SpvExecutionModeShader64BitIndexingEXT: return "SpvExecutionModeShader64BitIndexingEXT";
...
spirv_functionparameterattribute_to_string(SpvFunctionParameterAttribute v)
{
   ...
   case SpvFunctionParameterAttributeRuntimeAlignedALTERA: return "SpvFunctionParameterAttributeRuntimeAlignedALTERA";
...
spirv_storageclass_to_string(SpvStorageClass v)
{
   ...
   case SpvStorageClassTileAttachmentQCOM: return "SpvStorageClassTileAttachmentQCOM";
   ...
   case SpvStorageClassHitObjectAttributeEXT: return "SpvStorageClassHitObjectAttributeEXT";
   case SpvStorageClassCodeSectionINTEL: return "SpvStorageClassCodeSectionINTEL";
   case SpvStorageClassDeviceOnlyALTERA: return "SpvStorageClassDeviceOnlyALTERA";
   case SpvStorageClassHostOnlyALTERA: return "SpvStorageClassHostOnlyALTERA";
...
spirv_op_to_string(SpvOp v)
{
   ...
   case SpvOpTypeTensorARM: return "SpvOpTypeTensorARM";
   case SpvOpTensorReadARM: return "SpvOpTensorReadARM";
   case SpvOpTensorWriteARM: return "SpvOpTensorWriteARM";
   case SpvOpTensorQuerySizeARM: return "SpvOpTensorQuerySizeARM";
   case SpvOpGraphConstantARM: return "SpvOpGraphConstantARM";
   case SpvOpGraphEntryPointARM: return "SpvOpGraphEntryPointARM";
   case SpvOpGraphARM: return "SpvOpGraphARM";
   case SpvOpGraphInputARM: return "SpvOpGraphInputARM";
   case SpvOpGraphSetOutputARM: return "SpvOpGraphSetOutputARM";
   case SpvOpGraphEndARM: return "SpvOpGraphEndARM";
   case SpvOpTypeGraphARM: return "SpvOpTypeGraphARM";
   ...
   case SpvOpFmaKHR: return "SpvOpFmaKHR";
   ...
   case SpvOpUntypedGroupAsyncCopyKHR: return "SpvOpUntypedGroupAsyncCopyKHR";
   ...
   case SpvOpBitCastArrayQCOM: return "SpvOpBitCastArrayQCOM";
   ...
   case SpvOpCompositeConstructCoopMatQCOM: return "SpvOpCompositeConstructCoopMatQCOM";
   case SpvOpCompositeExtractCoopMatQCOM: return "SpvOpCompositeExtractCoopMatQCOM";
   case SpvOpExtractSubArrayQCOM: return "SpvOpExtractSubArrayQCOM";
   ...
   case SpvOpTypeBufferEXT: return "SpvOpTypeBufferEXT";
   case SpvOpBufferPointerEXT: return "SpvOpBufferPointerEXT";
   case SpvOpAbortKHR: return "SpvOpAbortKHR";
   case SpvOpUntypedImageTexelPointerEXT: return "SpvOpUntypedImageTexelPointerEXT";
   case SpvOpMemberDecorateIdEXT: return "SpvOpMemberDecorateIdEXT";
   case SpvOpConstantSizeOfEXT: return "SpvOpConstantSizeOfEXT";
   case SpvOpConstantDataKHR: return "SpvOpConstantDataKHR";
   case SpvOpSpecConstantDataKHR: return "SpvOpSpecConstantDataKHR";
   case SpvOpPoisonKHR: return "SpvOpPoisonKHR";
   case SpvOpFreezeKHR: return "SpvOpFreezeKHR";
   ...
   case SpvOpTypeVectorIdEXT: return "SpvOpTypeVectorIdEXT";
   ...
   case SpvOpGroupNonUniformPartitionEXT: return "SpvOpGroupNonUniformPartitionEXT";
   ...
   case SpvOpHitObjectRecordFromQueryEXT: return "SpvOpHitObjectRecordFromQueryEXT";
   case SpvOpHitObjectRecordMissEXT: return "SpvOpHitObjectRecordMissEXT";
   case SpvOpHitObjectRecordMissMotionEXT: return "SpvOpHitObjectRecordMissMotionEXT";
   case SpvOpHitObjectGetIntersectionTriangleVertexPositionsEXT: return "SpvOpHitObjectGetIntersectionTriangleVertexPositionsEXT";
   case SpvOpHitObjectGetRayFlagsEXT: return "SpvOpHitObjectGetRayFlagsEXT";
   case SpvOpHitObjectSetShaderBindingTableRecordIndexEXT: return "SpvOpHitObjectSetShaderBindingTableRecordIndexEXT";
   case SpvOpHitObjectReorderExecuteShaderEXT: return "SpvOpHitObjectReorderExecuteShaderEXT";
   case SpvOpHitObjectTraceReorderExecuteEXT: return "SpvOpHitObjectTraceReorderExecuteEXT";
   case SpvOpHitObjectTraceMotionReorderExecuteEXT: return "SpvOpHitObjectTraceMotionReorderExecuteEXT";
   case SpvOpTypeHitObjectEXT: return "SpvOpTypeHitObjectEXT";
   case SpvOpReorderThreadWithHintEXT: return "SpvOpReorderThreadWithHintEXT";
   case SpvOpReorderThreadWithHitObjectEXT: return "SpvOpReorderThreadWithHitObjectEXT";
   case SpvOpHitObjectTraceRayEXT: return "SpvOpHitObjectTraceRayEXT";
   case SpvOpHitObjectTraceRayMotionEXT: return "SpvOpHitObjectTraceRayMotionEXT";
   case SpvOpHitObjectRecordEmptyEXT: return "SpvOpHitObjectRecordEmptyEXT";
   case SpvOpHitObjectExecuteShaderEXT: return "SpvOpHitObjectExecuteShaderEXT";
   case SpvOpHitObjectGetCurrentTimeEXT: return "SpvOpHitObjectGetCurrentTimeEXT";
   case SpvOpHitObjectGetAttributesEXT: return "SpvOpHitObjectGetAttributesEXT";
   case SpvOpHitObjectGetHitKindEXT: return "SpvOpHitObjectGetHitKindEXT";
   case SpvOpHitObjectGetPrimitiveIndexEXT: return "SpvOpHitObjectGetPrimitiveIndexEXT";
   case SpvOpHitObjectGetGeometryIndexEXT: return "SpvOpHitObjectGetGeometryIndexEXT";
   case SpvOpHitObjectGetInstanceIdEXT: return "SpvOpHitObjectGetInstanceIdEXT";
   case SpvOpHitObjectGetInstanceCustomIndexEXT: return "SpvOpHitObjectGetInstanceCustomIndexEXT";
   case SpvOpHitObjectGetObjectRayOriginEXT: return "SpvOpHitObjectGetObjectRayOriginEXT";
   case SpvOpHitObjectGetObjectRayDirectionEXT: return "SpvOpHitObjectGetObjectRayDirectionEXT";
   case SpvOpHitObjectGetWorldRayDirectionEXT: return "SpvOpHitObjectGetWorldRayDirectionEXT";
   case SpvOpHitObjectGetWorldRayOriginEXT: return "SpvOpHitObjectGetWorldRayOriginEXT";
   case SpvOpHitObjectGetObjectToWorldEXT: return "SpvOpHitObjectGetObjectToWorldEXT";
   case SpvOpHitObjectGetWorldToObjectEXT: return "SpvOpHitObjectGetWorldToObjectEXT";
   case SpvOpHitObjectGetRayTMaxEXT: return "SpvOpHitObjectGetRayTMaxEXT";
   ...
   case SpvOpRayQueryGetIntersectionClusterIdNV: return "SpvOpRayQueryGetIntersectionClusterIdNV";
   case SpvOpHitObjectGetClusterIdNV: return "SpvOpHitObjectGetClusterIdNV";
   case SpvOpHitObjectGetRayTMinEXT: return "SpvOpHitObjectGetRayTMinEXT";
   case SpvOpHitObjectGetShaderBindingTableRecordIndexEXT: return "SpvOpHitObjectGetShaderBindingTableRecordIndexEXT";
   case SpvOpHitObjectGetShaderRecordBufferHandleEXT: return "SpvOpHitObjectGetShaderRecordBufferHandleEXT";
   case SpvOpHitObjectIsEmptyEXT: return "SpvOpHitObjectIsEmptyEXT";
   case SpvOpHitObjectIsHitEXT: return "SpvOpHitObjectIsHitEXT";
   case SpvOpHitObjectIsMissEXT: return "SpvOpHitObjectIsMissEXT";
   ...
   case SpvOpArbitraryFloatSinCosPiALTERA: return "SpvOpArbitraryFloatSinCosPiALTERA";
   case SpvOpArbitraryFloatCastALTERA: return "SpvOpArbitraryFloatCastALTERA";
   case SpvOpArbitraryFloatCastFromIntALTERA: return "SpvOpArbitraryFloatCastFromIntALTERA";
   case SpvOpArbitraryFloatCastToIntALTERA: return "SpvOpArbitraryFloatCastToIntALTERA";
   case SpvOpArbitraryFloatAddALTERA: return "SpvOpArbitraryFloatAddALTERA";
   case SpvOpArbitraryFloatSubALTERA: return "SpvOpArbitraryFloatSubALTERA";
   case SpvOpArbitraryFloatMulALTERA: return "SpvOpArbitraryFloatMulALTERA";
   case SpvOpArbitraryFloatDivALTERA: return "SpvOpArbitraryFloatDivALTERA";
   case SpvOpArbitraryFloatGTALTERA: return "SpvOpArbitraryFloatGTALTERA";
   case SpvOpArbitraryFloatGEALTERA: return "SpvOpArbitraryFloatGEALTERA";
   case SpvOpArbitraryFloatLTALTERA: return "SpvOpArbitraryFloatLTALTERA";
   case SpvOpArbitraryFloatLEALTERA: return "SpvOpArbitraryFloatLEALTERA";
   case SpvOpArbitraryFloatEQALTERA: return "SpvOpArbitraryFloatEQALTERA";
   case SpvOpArbitraryFloatRecipALTERA: return "SpvOpArbitraryFloatRecipALTERA";
   case SpvOpArbitraryFloatRSqrtALTERA: return "SpvOpArbitraryFloatRSqrtALTERA";
   case SpvOpArbitraryFloatCbrtALTERA: return "SpvOpArbitraryFloatCbrtALTERA";
   case SpvOpArbitraryFloatHypotALTERA: return "SpvOpArbitraryFloatHypotALTERA";
   case SpvOpArbitraryFloatSqrtALTERA: return "SpvOpArbitraryFloatSqrtALTERA";
   ...
   case SpvOpFixedSqrtALTERA: return "SpvOpFixedSqrtALTERA";
   case SpvOpFixedRecipALTERA: return "SpvOpFixedRecipALTERA";
   case SpvOpFixedRsqrtALTERA: return "SpvOpFixedRsqrtALTERA";
   case SpvOpFixedSinALTERA: return "SpvOpFixedSinALTERA";
   case SpvOpFixedCosALTERA: return "SpvOpFixedCosALTERA";
   case SpvOpFixedSinCosALTERA: return "SpvOpFixedSinCosALTERA";
   case SpvOpFixedSinPiALTERA: return "SpvOpFixedSinPiALTERA";
   case SpvOpFixedCosPiALTERA: return "SpvOpFixedCosPiALTERA";
   case SpvOpFixedSinCosPiALTERA: return "SpvOpFixedSinCosPiALTERA";
   case SpvOpFixedLogALTERA: return "SpvOpFixedLogALTERA";
   case SpvOpFixedExpALTERA: return "SpvOpFixedExpALTERA";
   case SpvOpPtrCastToCrossWorkgroupALTERA: return "SpvOpPtrCastToCrossWorkgroupALTERA";
   case SpvOpCrossWorkgroupCastToPtrALTERA: return "SpvOpCrossWorkgroupCastToPtrALTERA";
   case SpvOpReadPipeBlockingALTERA: return "SpvOpReadPipeBlockingALTERA";
   case SpvOpWritePipeBlockingALTERA: return "SpvOpWritePipeBlockingALTERA";
   case SpvOpFPGARegALTERA: return "SpvOpFPGARegALTERA";
   ...
   case SpvOpTaskSequenceGetALTERA: return "SpvOpTaskSequenceGetALTERA";
   case SpvOpTaskSequenceReleaseALTERA: return "SpvOpTaskSequenceReleaseALTERA";
   case SpvOpTypeTaskSequenceALTERA: return "SpvOpTypeTaskSequenceALTERA";
   ...
   case SpvOpBitwiseFunctionINTEL: return "SpvOpBitwiseFunctionINTEL";
   case SpvOpUntypedVariableLengthArrayINTEL: return "SpvOpUntypedVariableLengthArrayINTEL";
   case SpvOpConditionalExtensionINTEL: return "SpvOpConditionalExtensionINTEL";
   case SpvOpConditionalEntryPointINTEL: return "SpvOpConditionalEntryPointINTEL";
   case SpvOpConditionalCapabilityINTEL: return "SpvOpConditionalCapabilityINTEL";
   case SpvOpSpecConstantTargetINTEL: return "SpvOpSpecConstantTargetINTEL";
   ...
   case SpvOpConvertHandleToImageINTEL: return "SpvOpConvertHandleToImageINTEL";
   case SpvOpConvertHandleToSamplerINTEL: return "SpvOpConvertHandleToSamplerINTEL";
   case SpvOpConvertHandleToSampledImageINTEL: return "SpvOpConvertHandleToSampledImageINTEL";
   case SpvOpFDot2MixAcc32VALVE: return "SpvOpFDot2MixAcc32VALVE";
   case SpvOpFDot2MixAcc16VALVE: return "SpvOpFDot2MixAcc16VALVE";
   case SpvOpFDot4MixAcc32VALVE: return "SpvOpFDot4MixAcc32VALVE";
