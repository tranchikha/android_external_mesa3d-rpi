/* Generated code, see vc4_packet.xml, v3d_packet.xml and gen_pack_header.py */


/* Packets, enums and structures for V3D 7.1.
 *
...
enum V3D71_Varying_Flags_Action {
...
enum V3D71_Internal_BPP {
        V3D_INTERNAL_BPP_32                  =      0,
        V3D_INTERNAL_BPP_64                  =      1,
        V3D_INTERNAL_BPP_128                 =      2,
};

enum V3D71_Internal_Depth_Type {
        V3D_INTERNAL_TYPE_DEPTH_32F          =      0,
        V3D_INTERNAL_TYPE_DEPTH_24           =      1,
        V3D_INTERNAL_TYPE_DEPTH_16           =      2,
};

enum V3D71_Render_Target_Type_Clamp {
        V3D_RENDER_TARGET_TYPE_CLAMP_8I      =      0,
        V3D_RENDER_TARGET_TYPE_CLAMP_16I     =      1,
        V3D_RENDER_TARGET_TYPE_CLAMP_32I     =      2,
        V3D_RENDER_TARGET_TYPE_CLAMP_8UI     =      4,
        V3D_RENDER_TARGET_TYPE_CLAMP_16UI    =      5,
        V3D_RENDER_TARGET_TYPE_CLAMP_32UI    =      6,
        V3D_RENDER_TARGET_TYPE_CLAMP_8       =      8,
        V3D_RENDER_TARGET_TYPE_CLAMP_16F     =      9,
        V3D_RENDER_TARGET_TYPE_CLAMP_32F     =     10,
        V3D_RENDER_TARGET_TYPE_CLAMP_8I_CLAMPED =     16,
        V3D_RENDER_TARGET_TYPE_CLAMP_16I_CLAMPED =     17,
        V3D_RENDER_TARGET_TYPE_CLAMP_32I_CLAMPED =     18,
        V3D_RENDER_TARGET_TYPE_CLAMP_8UI_CLAMPED =     20,
        V3D_RENDER_TARGET_TYPE_CLAMP_16UI_CLAMPED =     21,
        V3D_RENDER_TARGET_TYPE_CLAMP_32UI_CLAMPED =     22,
        V3D_RENDER_TARGET_TYPE_CLAMP_16F_CLAMP_NORM =     24,
        V3D_RENDER_TARGET_TYPE_CLAMP_16F_CLAMP_POS =     25,
        V3D_RENDER_TARGET_TYPE_CLAMP_16F_CLAMP_PQ =     26,
        V3D_RENDER_TARGET_TYPE_CLAMP_16F_CLAMP_HLG =     27,
        V3D_RENDER_TARGET_TYPE_CLAMP_INVALID =     32,
};

enum V3D71_L2T_Flush_Mode {
...
enum V3D71_Output_Image_Format {
        ...
        V3D_OUTPUT_IMAGE_FORMAT_BSTC8_SRGB   =     46,
        V3D_OUTPUT_IMAGE_FORMAT_BSTC10       =     47,
        V3D_OUTPUT_IMAGE_FORMAT_BSTC10_SRGB  =     48,
        V3D_OUTPUT_IMAGE_FORMAT_BSTC10_PQ    =     49,
        V3D_OUTPUT_IMAGE_FORMAT_RGBA10X6     =     50,
        V3D_OUTPUT_IMAGE_FORMAT_BSTC10_HLG   =     55,
        V3D_OUTPUT_IMAGE_FORMAT_RGBA10X6_HLG =     56,
        V3D_OUTPUT_IMAGE_FORMAT_RGB10_A2_HLG =     57,
        V3D_OUTPUT_IMAGE_FORMAT_BSTC10_PQ_BT1886 =     58,
        V3D_OUTPUT_IMAGE_FORMAT_RGBA10X6_PQ_BT1886 =     59,
        V3D_OUTPUT_IMAGE_FORMAT_RGB10_A2_PQ_BT1886 =     60,
        V3D_OUTPUT_IMAGE_FORMAT_BSTC10_HLG_BT1886 =     61,
        V3D_OUTPUT_IMAGE_FORMAT_RGBA10X6_HLG_BT1886 =     62,
        V3D_OUTPUT_IMAGE_FORMAT_RGB10_A2_HLG_BT1886 =     63,
};

enum V3D71_Dither_Mode {
...
enum V3D71_Line_Rasterization {
        V3D_LINE_RASTERIZATION_DIAMOND_EXIT  =      0,
        V3D_LINE_RASTERIZATION_PERP_END_CAPS =      1,
};

enum V3D71_Z_Clip_Mode {
        V3D_Z_CLIP_MODE_NONE                 =      0,
        V3D_Z_CLIP_MODE_MIN_ONE_TO_ONE       =      1,
        V3D_Z_CLIP_MODE_ZERO_TO_ONE          =      2,
};

enum V3D71_Texture_Data_Formats {
...
#define V3D71_HALT_opcode                      0
#define V3D71_HALT_header                       \
   .opcode                              =      0
...
static inline void
V3D71_HALT_pack(__gen_user_data *data, uint8_t * restrict cl,
                const struct V3D71_HALT * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);

}

#define V3D71_HALT_length                      1
#ifdef __gen_unpack_address
static inline void
V3D71_HALT_unpack(const uint8_t * restrict cl,
                  struct V3D71_HALT * restrict values)
{
...
#define V3D71_NOP_opcode                       1
#define V3D71_NOP_header                        \
   .opcode                              =      1
...
static inline void
V3D71_NOP_pack(__gen_user_data *data, uint8_t * restrict cl,
               const struct V3D71_NOP * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);

}

#define V3D71_NOP_length                       1
#ifdef __gen_unpack_address
static inline void
V3D71_NOP_unpack(const uint8_t * restrict cl,
                 struct V3D71_NOP * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D71_FLUSH_opcode                     4
#define V3D71_FLUSH_header                      \
   .opcode                              =      4
...
static inline void
V3D71_FLUSH_pack(__gen_user_data *data, uint8_t * restrict cl,
...
#define V3D71_FLUSH_ALL_STATE_opcode           5
#define V3D71_FLUSH_ALL_STATE_header            \
   .opcode                              =      5

struct V3D71_FLUSH_ALL_STATE {
   uint32_t                             opcode;
};

static inline void
V3D71_FLUSH_ALL_STATE_pack(__gen_user_data *data, uint8_t * restrict cl,
                           const struct V3D71_FLUSH_ALL_STATE * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);

}

#define V3D71_FLUSH_ALL_STATE_length           1
#ifdef __gen_unpack_address
static inline void
V3D71_FLUSH_ALL_STATE_unpack(const uint8_t * restrict cl,
                             struct V3D71_FLUSH_ALL_STATE * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D71_START_TILE_BINNING_opcode        6
#define V3D71_START_TILE_BINNING_header         \
   .opcode                              =      6
...
static inline void
V3D71_START_TILE_BINNING_pack(__gen_user_data *data, uint8_t * restrict cl,
                              const struct V3D71_START_TILE_BINNING * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);

}

#define V3D71_START_TILE_BINNING_length        1
#ifdef __gen_unpack_address
static inline void
V3D71_START_TILE_BINNING_unpack(const uint8_t * restrict cl,
                                struct V3D71_START_TILE_BINNING * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D71_INCREMENT_SEMAPHORE_opcode       7
#define V3D71_INCREMENT_SEMAPHORE_header        \
   .opcode                              =      7

struct V3D71_INCREMENT_SEMAPHORE {
   uint32_t                             opcode;
};

static inline void
V3D71_INCREMENT_SEMAPHORE_pack(__gen_user_data *data, uint8_t * restrict cl,
                               const struct V3D71_INCREMENT_SEMAPHORE * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);

}

#define V3D71_INCREMENT_SEMAPHORE_length       1
#ifdef __gen_unpack_address
static inline void
V3D71_INCREMENT_SEMAPHORE_unpack(const uint8_t * restrict cl,
                                 struct V3D71_INCREMENT_SEMAPHORE * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D71_WAIT_ON_SEMAPHORE_opcode         8
#define V3D71_WAIT_ON_SEMAPHORE_header          \
   .opcode                              =      8

struct V3D71_WAIT_ON_SEMAPHORE {
   uint32_t                             opcode;
};

static inline void
V3D71_WAIT_ON_SEMAPHORE_pack(__gen_user_data *data, uint8_t * restrict cl,
                             const struct V3D71_WAIT_ON_SEMAPHORE * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);

}

#define V3D71_WAIT_ON_SEMAPHORE_length         1
#ifdef __gen_unpack_address
static inline void
V3D71_WAIT_ON_SEMAPHORE_unpack(const uint8_t * restrict cl,
                               struct V3D71_WAIT_ON_SEMAPHORE * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D71_WAIT_FOR_PREVIOUS_FRAME_opcode      9
#define V3D71_WAIT_FOR_PREVIOUS_FRAME_header    \
   .opcode                              =      9

struct V3D71_WAIT_FOR_PREVIOUS_FRAME {
   uint32_t                             opcode;
};

static inline void
V3D71_WAIT_FOR_PREVIOUS_FRAME_pack(__gen_user_data *data, uint8_t * restrict cl,
                                   const struct V3D71_WAIT_FOR_PREVIOUS_FRAME * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);

}

#define V3D71_WAIT_FOR_PREVIOUS_FRAME_length      1
#ifdef __gen_unpack_address
static inline void
V3D71_WAIT_FOR_PREVIOUS_FRAME_unpack(const uint8_t * restrict cl,
                                     struct V3D71_WAIT_FOR_PREVIOUS_FRAME * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D71_ENABLE_Z_ONLY_RENDERING_opcode     10
#define V3D71_ENABLE_Z_ONLY_RENDERING_header    \
   .opcode                              =     10

struct V3D71_ENABLE_Z_ONLY_RENDERING {
   uint32_t                             opcode;
};

static inline void
V3D71_ENABLE_Z_ONLY_RENDERING_pack(__gen_user_data *data, uint8_t * restrict cl,
                                   const struct V3D71_ENABLE_Z_ONLY_RENDERING * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);

}

#define V3D71_ENABLE_Z_ONLY_RENDERING_length      1
#ifdef __gen_unpack_address
static inline void
V3D71_ENABLE_Z_ONLY_RENDERING_unpack(const uint8_t * restrict cl,
                                     struct V3D71_ENABLE_Z_ONLY_RENDERING * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D71_DISABLE_Z_ONLY_RENDERING_opcode     11
#define V3D71_DISABLE_Z_ONLY_RENDERING_header   \
   .opcode                              =     11

struct V3D71_DISABLE_Z_ONLY_RENDERING {
   uint32_t                             opcode;
};

static inline void
V3D71_DISABLE_Z_ONLY_RENDERING_pack(__gen_user_data *data, uint8_t * restrict cl,
                                    const struct V3D71_DISABLE_Z_ONLY_RENDERING * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);

}

#define V3D71_DISABLE_Z_ONLY_RENDERING_length      1
#ifdef __gen_unpack_address
static inline void
V3D71_DISABLE_Z_ONLY_RENDERING_unpack(const uint8_t * restrict cl,
                                      struct V3D71_DISABLE_Z_ONLY_RENDERING * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D71_END_OF_Z_ONLY_RENDERING_IN_FRAME_opcode     12
#define V3D71_END_OF_Z_ONLY_RENDERING_IN_FRAME_header\
   .opcode                              =     12

struct V3D71_END_OF_Z_ONLY_RENDERING_IN_FRAME {
   uint32_t                             opcode;
};

static inline void
V3D71_END_OF_Z_ONLY_RENDERING_IN_FRAME_pack(__gen_user_data *data, uint8_t * restrict cl,
                                            const struct V3D71_END_OF_Z_ONLY_RENDERING_IN_FRAME * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);

}

#define V3D71_END_OF_Z_ONLY_RENDERING_IN_FRAME_length      1
#ifdef __gen_unpack_address
static inline void
V3D71_END_OF_Z_ONLY_RENDERING_IN_FRAME_unpack(const uint8_t * restrict cl,
                                              struct V3D71_END_OF_Z_ONLY_RENDERING_IN_FRAME * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D71_END_OF_RENDERING_opcode         13
#define V3D71_END_OF_RENDERING_header           \
   .opcode                              =     13

struct V3D71_END_OF_RENDERING {
   uint32_t                             opcode;
};

static inline void
V3D71_END_OF_RENDERING_pack(__gen_user_data *data, uint8_t * restrict cl,
                            const struct V3D71_END_OF_RENDERING * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);

}

#define V3D71_END_OF_RENDERING_length          1
#ifdef __gen_unpack_address
static inline void
V3D71_END_OF_RENDERING_unpack(const uint8_t * restrict cl,
                              struct V3D71_END_OF_RENDERING * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D71_WAIT_FOR_TRANSFORM_FEEDBACK_opcode     14
#define V3D71_WAIT_FOR_TRANSFORM_FEEDBACK_header\
   .opcode                              =     14

struct V3D71_WAIT_FOR_TRANSFORM_FEEDBACK {
   uint32_t                             opcode;
   uint32_t                             block_count;
};

static inline void
V3D71_WAIT_FOR_TRANSFORM_FEEDBACK_pack(__gen_user_data *data, uint8_t * restrict cl,
                                       const struct V3D71_WAIT_FOR_TRANSFORM_FEEDBACK * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_WAIT_FOR_TRANSFORM_FEEDBACK_length      2
#ifdef __gen_unpack_address
static inline void
V3D71_WAIT_FOR_TRANSFORM_FEEDBACK_unpack(const uint8_t * restrict cl,
                                         struct V3D71_WAIT_FOR_TRANSFORM_FEEDBACK * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D71_BRANCH_TO_AUTO_CHAINED_SUB_LIST_opcode     15
#define V3D71_BRANCH_TO_AUTO_CHAINED_SUB_LIST_header\
   .opcode                              =     15

struct V3D71_BRANCH_TO_AUTO_CHAINED_SUB_LIST {
   uint32_t                             opcode;
   __gen_address_type                   address;
};

static inline void
V3D71_BRANCH_TO_AUTO_CHAINED_SUB_LIST_pack(__gen_user_data *data, uint8_t * restrict cl,
                                           const struct V3D71_BRANCH_TO_AUTO_CHAINED_SUB_LIST * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_BRANCH_TO_AUTO_CHAINED_SUB_LIST_length      5
#ifdef __gen_unpack_address
static inline void
V3D71_BRANCH_TO_AUTO_CHAINED_SUB_LIST_unpack(const uint8_t * restrict cl,
                                             struct V3D71_BRANCH_TO_AUTO_CHAINED_SUB_LIST * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D71_BRANCH_opcode                   16
#define V3D71_BRANCH_header                     \
   .opcode                              =     16
...
static inline void
V3D71_BRANCH_pack(__gen_user_data *data, uint8_t * restrict cl,
                  const struct V3D71_BRANCH * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_BRANCH_length                    5
#ifdef __gen_unpack_address
static inline void
V3D71_BRANCH_unpack(const uint8_t * restrict cl,
                    struct V3D71_BRANCH * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
   values->address = __gen_unpack_address(cl, 8, 39);
}
...
#define V3D71_BRANCH_TO_SUB_LIST_opcode       17
#define V3D71_BRANCH_TO_SUB_LIST_header         \
   .opcode                              =     17

struct V3D71_BRANCH_TO_SUB_LIST {
   uint32_t                             opcode;
   __gen_address_type                   address;
};

static inline void
V3D71_BRANCH_TO_SUB_LIST_pack(__gen_user_data *data, uint8_t * restrict cl,
                              const struct V3D71_BRANCH_TO_SUB_LIST * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_BRANCH_TO_SUB_LIST_length        5
#ifdef __gen_unpack_address
static inline void
V3D71_BRANCH_TO_SUB_LIST_unpack(const uint8_t * restrict cl,
                                struct V3D71_BRANCH_TO_SUB_LIST * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
   values->address = __gen_unpack_address(cl, 8, 39);
}
...
#define V3D71_RETURN_FROM_SUB_LIST_opcode     18
#define V3D71_RETURN_FROM_SUB_LIST_header       \
   .opcode                              =     18

struct V3D71_RETURN_FROM_SUB_LIST {
   uint32_t                             opcode;
};

static inline void
V3D71_RETURN_FROM_SUB_LIST_pack(__gen_user_data *data, uint8_t * restrict cl,
                                const struct V3D71_RETURN_FROM_SUB_LIST * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);

}

#define V3D71_RETURN_FROM_SUB_LIST_length      1
#ifdef __gen_unpack_address
static inline void
V3D71_RETURN_FROM_SUB_LIST_unpack(const uint8_t * restrict cl,
                                  struct V3D71_RETURN_FROM_SUB_LIST * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D71_FLUSH_VCD_CACHE_opcode          19
#define V3D71_FLUSH_VCD_CACHE_header            \
   .opcode                              =     19
...
static inline void
V3D71_FLUSH_VCD_CACHE_pack(__gen_user_data *data, uint8_t * restrict cl,
                           const struct V3D71_FLUSH_VCD_CACHE * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);

}

#define V3D71_FLUSH_VCD_CACHE_length           1
#ifdef __gen_unpack_address
static inline void
V3D71_FLUSH_VCD_CACHE_unpack(const uint8_t * restrict cl,
                             struct V3D71_FLUSH_VCD_CACHE * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D71_START_ADDRESS_OF_GENERIC_TILE_LIST_opcode     20
#define V3D71_START_ADDRESS_OF_GENERIC_TILE_LIST_header\
   .opcode                              =     20

struct V3D71_START_ADDRESS_OF_GENERIC_TILE_LIST {
   uint32_t                             opcode;
...
static inline void
V3D71_START_ADDRESS_OF_GENERIC_TILE_LIST_pack(__gen_user_data *data, uint8_t * restrict cl,
                                              const struct V3D71_START_ADDRESS_OF_GENERIC_TILE_LIST * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_START_ADDRESS_OF_GENERIC_TILE_LIST_length      9
#ifdef __gen_unpack_address
static inline void
V3D71_START_ADDRESS_OF_GENERIC_TILE_LIST_unpack(const uint8_t * restrict cl,
                                                struct V3D71_START_ADDRESS_OF_GENERIC_TILE_LIST * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D71_BRANCH_TO_IMPLICIT_TILE_LIST_opcode     21
#define V3D71_BRANCH_TO_IMPLICIT_TILE_LIST_header\
   .opcode                              =     21

struct V3D71_BRANCH_TO_IMPLICIT_TILE_LIST {
   uint32_t                             opcode;
   uint32_t                             tile_list_set_number;
};

static inline void
V3D71_BRANCH_TO_IMPLICIT_TILE_LIST_pack(__gen_user_data *data, uint8_t * restrict cl,
                                        const struct V3D71_BRANCH_TO_IMPLICIT_TILE_LIST * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_BRANCH_TO_IMPLICIT_TILE_LIST_length      2
#ifdef __gen_unpack_address
static inline void
V3D71_BRANCH_TO_IMPLICIT_TILE_LIST_unpack(const uint8_t * restrict cl,
                                          struct V3D71_BRANCH_TO_IMPLICIT_TILE_LIST * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D71_BRANCH_TO_EXPLICIT_SUPERTILE_opcode     22
#define V3D71_BRANCH_TO_EXPLICIT_SUPERTILE_header\
   .opcode                              =     22

struct V3D71_BRANCH_TO_EXPLICIT_SUPERTILE {
   uint32_t                             opcode;
...
static inline void
V3D71_BRANCH_TO_EXPLICIT_SUPERTILE_pack(__gen_user_data *data, uint8_t * restrict cl,
                                        const struct V3D71_BRANCH_TO_EXPLICIT_SUPERTILE * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_BRANCH_TO_EXPLICIT_SUPERTILE_length      8
#ifdef __gen_unpack_address
static inline void
V3D71_BRANCH_TO_EXPLICIT_SUPERTILE_unpack(const uint8_t * restrict cl,
                                          struct V3D71_BRANCH_TO_EXPLICIT_SUPERTILE * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D71_SUPERTILE_COORDINATES_opcode     23
#define V3D71_SUPERTILE_COORDINATES_header      \
   .opcode                              =     23

struct V3D71_SUPERTILE_COORDINATES {
   uint32_t                             opcode;
...
static inline void
V3D71_SUPERTILE_COORDINATES_pack(__gen_user_data *data, uint8_t * restrict cl,
                                 const struct V3D71_SUPERTILE_COORDINATES * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_SUPERTILE_COORDINATES_length      3
#ifdef __gen_unpack_address
static inline void
V3D71_SUPERTILE_COORDINATES_unpack(const uint8_t * restrict cl,
                                   struct V3D71_SUPERTILE_COORDINATES * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D71_CLEAR_RENDER_TARGETS_opcode     25
#define V3D71_CLEAR_RENDER_TARGETS_header       \
   .opcode                              =     25

struct V3D71_CLEAR_RENDER_TARGETS {
   uint32_t                             opcode;
};

static inline void
V3D71_CLEAR_RENDER_TARGETS_pack(__gen_user_data *data, uint8_t * restrict cl,
                                const struct V3D71_CLEAR_RENDER_TARGETS * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);

}

#define V3D71_CLEAR_RENDER_TARGETS_length      1
#ifdef __gen_unpack_address
static inline void
V3D71_CLEAR_RENDER_TARGETS_unpack(const uint8_t * restrict cl,
                                  struct V3D71_CLEAR_RENDER_TARGETS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D71_END_OF_LOADS_opcode             26
#define V3D71_END_OF_LOADS_header               \
   .opcode                              =     26

struct V3D71_END_OF_LOADS {
   uint32_t                             opcode;
};

static inline void
V3D71_END_OF_LOADS_pack(__gen_user_data *data, uint8_t * restrict cl,
                        const struct V3D71_END_OF_LOADS * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);

}

#define V3D71_END_OF_LOADS_length              1
#ifdef __gen_unpack_address
static inline void
V3D71_END_OF_LOADS_unpack(const uint8_t * restrict cl,
                          struct V3D71_END_OF_LOADS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D71_END_OF_TILE_MARKER_opcode       27
#define V3D71_END_OF_TILE_MARKER_header         \
   .opcode                              =     27

struct V3D71_END_OF_TILE_MARKER {
   uint32_t                             opcode;
};

static inline void
V3D71_END_OF_TILE_MARKER_pack(__gen_user_data *data, uint8_t * restrict cl,
                              const struct V3D71_END_OF_TILE_MARKER * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);

}

#define V3D71_END_OF_TILE_MARKER_length        1
#ifdef __gen_unpack_address
static inline void
V3D71_END_OF_TILE_MARKER_unpack(const uint8_t * restrict cl,
                                struct V3D71_END_OF_TILE_MARKER * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D71_STORE_TILE_BUFFER_GENERAL_opcode     29
#define V3D71_STORE_TILE_BUFFER_GENERAL_header  \
   .opcode                              =     29

struct V3D71_STORE_TILE_BUFFER_GENERAL {
   uint32_t                             opcode;
   __gen_address_type                   address;
   uint32_t                             height;
   ...
   enum V3D71_Output_Image_Format       output_image_format;
   enum V3D71_Decimate_Mode             decimate_mode;
   enum V3D71_Dither_Mode               dither_mode;
   bool                                 flip_y;
   enum V3D71_Memory_Format             memory_format;
   uint32_t                             buffer_to_store;
#define RENDER_TARGET_0                          0
#define RENDER_TARGET_1                          1
#define RENDER_TARGET_2                          2
#define RENDER_TARGET_3                          3
#define RENDER_TARGET_4                          4
#define RENDER_TARGET_5                          5
#define RENDER_TARGET_6                          6
#define RENDER_TARGET_7                          7
#define NONE                                     8
#define Z                                        9
#define STENCIL                                  10
#define ZSTENCIL                                 11
...
static inline void
V3D71_STORE_TILE_BUFFER_GENERAL_pack(__gen_user_data *data, uint8_t * restrict cl,
                                     const struct V3D71_STORE_TILE_BUFFER_GENERAL * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_STORE_TILE_BUFFER_GENERAL_length     13
#ifdef __gen_unpack_address
static inline void
V3D71_STORE_TILE_BUFFER_GENERAL_unpack(const uint8_t * restrict cl,
                                       struct V3D71_STORE_TILE_BUFFER_GENERAL * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D71_LOAD_TILE_BUFFER_GENERAL_opcode     30
#define V3D71_LOAD_TILE_BUFFER_GENERAL_header   \
   .opcode                              =     30

struct V3D71_LOAD_TILE_BUFFER_GENERAL {
   uint32_t                             opcode;
   __gen_address_type                   address;
   uint32_t                             height;
   uint32_t                             height_in_ub_or_stride;
   ...
   bool                                 channel_reverse;
   bool                                 force_alpha_1;
   enum V3D71_Output_Image_Format       input_image_format;
   enum V3D71_Decimate_Mode             decimate_mode;
   bool                                 flip_y;
   enum V3D71_Memory_Format             memory_format;
...
static inline void
V3D71_LOAD_TILE_BUFFER_GENERAL_pack(__gen_user_data *data, uint8_t * restrict cl,
                                    const struct V3D71_LOAD_TILE_BUFFER_GENERAL * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_LOAD_TILE_BUFFER_GENERAL_length     13
#ifdef __gen_unpack_address
static inline void
V3D71_LOAD_TILE_BUFFER_GENERAL_unpack(const uint8_t * restrict cl,
                                      struct V3D71_LOAD_TILE_BUFFER_GENERAL * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
   values->address = __gen_unpack_address(cl, 72, 103);
   values->height = __gen_unpack_uint(cl, 56, 71);
...
#define V3D71_TRANSFORM_FEEDBACK_FLUSH_AND_COUNT_opcode     31
#define V3D71_TRANSFORM_FEEDBACK_FLUSH_AND_COUNT_header\
   .opcode                              =     31

struct V3D71_TRANSFORM_FEEDBACK_FLUSH_AND_COUNT {
   uint32_t                             opcode;
};

static inline void
V3D71_TRANSFORM_FEEDBACK_FLUSH_AND_COUNT_pack(__gen_user_data *data, uint8_t * restrict cl,
                                              const struct V3D71_TRANSFORM_FEEDBACK_FLUSH_AND_COUNT * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);

}

#define V3D71_TRANSFORM_FEEDBACK_FLUSH_AND_COUNT_length      1
#ifdef __gen_unpack_address
static inline void
V3D71_TRANSFORM_FEEDBACK_FLUSH_AND_COUNT_unpack(const uint8_t * restrict cl,
                                                struct V3D71_TRANSFORM_FEEDBACK_FLUSH_AND_COUNT * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D71_INDEXED_PRIM_LIST_opcode        32
#define V3D71_INDEXED_PRIM_LIST_header          \
   .opcode                              =     32

struct V3D71_INDEXED_PRIM_LIST {
   uint32_t                             opcode;
...
#define INDEX_TYPE_32_BIT                        2
   enum V3D71_Primitive                 mode;
};

static inline void
V3D71_INDEXED_PRIM_LIST_pack(__gen_user_data *data, uint8_t * restrict cl,
                             const struct V3D71_INDEXED_PRIM_LIST * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_INDEXED_PRIM_LIST_length        10
#ifdef __gen_unpack_address
static inline void
V3D71_INDEXED_PRIM_LIST_unpack(const uint8_t * restrict cl,
                               struct V3D71_INDEXED_PRIM_LIST * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D71_INDIRECT_INDEXED_INSTANCED_PRIM_LIST_opcode     33
#define V3D71_INDIRECT_INDEXED_INSTANCED_PRIM_LIST_header\
   .opcode                              =     33

struct V3D71_INDIRECT_INDEXED_INSTANCED_PRIM_LIST {
   uint32_t                             opcode;
...
static inline void
V3D71_INDIRECT_INDEXED_INSTANCED_PRIM_LIST_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                const struct V3D71_INDIRECT_INDEXED_INSTANCED_PRIM_LIST * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_INDIRECT_INDEXED_INSTANCED_PRIM_LIST_length     11
#ifdef __gen_unpack_address
static inline void
V3D71_INDIRECT_INDEXED_INSTANCED_PRIM_LIST_unpack(const uint8_t * restrict cl,
                                                  struct V3D71_INDIRECT_INDEXED_INSTANCED_PRIM_LIST * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D71_INDEXED_INSTANCED_PRIM_LIST_opcode     34
#define V3D71_INDEXED_INSTANCED_PRIM_LIST_header\
   .opcode                              =     34

struct V3D71_INDEXED_INSTANCED_PRIM_LIST {
   uint32_t                             opcode;
   uint32_t                             index_offset;
...
static inline void
V3D71_INDEXED_INSTANCED_PRIM_LIST_pack(__gen_user_data *data, uint8_t * restrict cl,
                                       const struct V3D71_INDEXED_INSTANCED_PRIM_LIST * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_INDEXED_INSTANCED_PRIM_LIST_length     14
#ifdef __gen_unpack_address
static inline void
V3D71_INDEXED_INSTANCED_PRIM_LIST_unpack(const uint8_t * restrict cl,
                                         struct V3D71_INDEXED_INSTANCED_PRIM_LIST * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D71_VERTEX_ARRAY_PRIMS_opcode       36
#define V3D71_VERTEX_ARRAY_PRIMS_header         \
   .opcode                              =     36

struct V3D71_VERTEX_ARRAY_PRIMS {
   uint32_t                             opcode;
...
static inline void
V3D71_VERTEX_ARRAY_PRIMS_pack(__gen_user_data *data, uint8_t * restrict cl,
                              const struct V3D71_VERTEX_ARRAY_PRIMS * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_VERTEX_ARRAY_PRIMS_length       10
#ifdef __gen_unpack_address
static inline void
V3D71_VERTEX_ARRAY_PRIMS_unpack(const uint8_t * restrict cl,
                                struct V3D71_VERTEX_ARRAY_PRIMS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D71_INDIRECT_VERTEX_ARRAY_INSTANCED_PRIMS_opcode     37
#define V3D71_INDIRECT_VERTEX_ARRAY_INSTANCED_PRIMS_header\
   .opcode                              =     37

struct V3D71_INDIRECT_VERTEX_ARRAY_INSTANCED_PRIMS {
   uint32_t                             opcode;
   uint32_t                             stride_in_multiples_of_4_bytes;
   __gen_address_type                   address;
...
static inline void
V3D71_INDIRECT_VERTEX_ARRAY_INSTANCED_PRIMS_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                 const struct V3D71_INDIRECT_VERTEX_ARRAY_INSTANCED_PRIMS * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_INDIRECT_VERTEX_ARRAY_INSTANCED_PRIMS_length     11
#ifdef __gen_unpack_address
static inline void
V3D71_INDIRECT_VERTEX_ARRAY_INSTANCED_PRIMS_unpack(const uint8_t * restrict cl,
                                                   struct V3D71_INDIRECT_VERTEX_ARRAY_INSTANCED_PRIMS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
   values->stride_in_multiples_of_4_bytes = __gen_unpack_uint(cl, 80, 87);
   values->address = __gen_unpack_address(cl, 48, 79);
...
#define V3D71_VERTEX_ARRAY_INSTANCED_PRIMS_opcode     38
#define V3D71_VERTEX_ARRAY_INSTANCED_PRIMS_header\
   .opcode                              =     38

struct V3D71_VERTEX_ARRAY_INSTANCED_PRIMS {
   uint32_t                             opcode;
   uint32_t                             index_of_first_vertex;
   uint32_t                             number_of_instances;
   uint32_t                             instance_length;
...
static inline void
V3D71_VERTEX_ARRAY_INSTANCED_PRIMS_pack(__gen_user_data *data, uint8_t * restrict cl,
                                        const struct V3D71_VERTEX_ARRAY_INSTANCED_PRIMS * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_VERTEX_ARRAY_INSTANCED_PRIMS_length     14
#ifdef __gen_unpack_address
static inline void
V3D71_VERTEX_ARRAY_INSTANCED_PRIMS_unpack(const uint8_t * restrict cl,
                                          struct V3D71_VERTEX_ARRAY_INSTANCED_PRIMS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D71_VERTEX_ARRAY_SINGLE_INSTANCE_PRIMS_opcode     39
#define V3D71_VERTEX_ARRAY_SINGLE_INSTANCE_PRIMS_header\
   .opcode                              =     39

struct V3D71_VERTEX_ARRAY_SINGLE_INSTANCE_PRIMS {
   uint32_t                             opcode;
   uint32_t                             index_of_first_vertex;
...
static inline void
V3D71_VERTEX_ARRAY_SINGLE_INSTANCE_PRIMS_pack(__gen_user_data *data, uint8_t * restrict cl,
                                              const struct V3D71_VERTEX_ARRAY_SINGLE_INSTANCE_PRIMS * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_VERTEX_ARRAY_SINGLE_INSTANCE_PRIMS_length     14
#ifdef __gen_unpack_address
static inline void
V3D71_VERTEX_ARRAY_SINGLE_INSTANCE_PRIMS_unpack(const uint8_t * restrict cl,
                                                struct V3D71_VERTEX_ARRAY_SINGLE_INSTANCE_PRIMS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
   values->index_of_first_vertex = __gen_unpack_uint(cl, 80, 111);
...
#define V3D71_BASE_VERTEX_BASE_INSTANCE_opcode     43
#define V3D71_BASE_VERTEX_BASE_INSTANCE_header  \
   .opcode                              =     43

struct V3D71_BASE_VERTEX_BASE_INSTANCE {
   uint32_t                             opcode;
...
static inline void
V3D71_BASE_VERTEX_BASE_INSTANCE_pack(__gen_user_data *data, uint8_t * restrict cl,
                                     const struct V3D71_BASE_VERTEX_BASE_INSTANCE * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_BASE_VERTEX_BASE_INSTANCE_length      9
#ifdef __gen_unpack_address
static inline void
V3D71_BASE_VERTEX_BASE_INSTANCE_unpack(const uint8_t * restrict cl,
                                       struct V3D71_BASE_VERTEX_BASE_INSTANCE * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D71_INDEX_BUFFER_SETUP_opcode       44
#define V3D71_INDEX_BUFFER_SETUP_header         \
   .opcode                              =     44

struct V3D71_INDEX_BUFFER_SETUP {
   uint32_t                             opcode;
   __gen_address_type                   address;
   uint32_t                             size;
};
...
static inline void
V3D71_INDEX_BUFFER_SETUP_pack(__gen_user_data *data, uint8_t * restrict cl,
                              const struct V3D71_INDEX_BUFFER_SETUP * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_INDEX_BUFFER_SETUP_length        9
#ifdef __gen_unpack_address
static inline void
V3D71_INDEX_BUFFER_SETUP_unpack(const uint8_t * restrict cl,
                                struct V3D71_INDEX_BUFFER_SETUP * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
   values->address = __gen_unpack_address(cl, 8, 39);
...
#define V3D71_SET_INSTANCEID_opcode           54
#define V3D71_SET_INSTANCEID_header             \
   .opcode                              =     54

struct V3D71_SET_INSTANCEID {
   uint32_t                             opcode;
   uint32_t                             instance_id;
};

static inline void
V3D71_SET_INSTANCEID_pack(__gen_user_data *data, uint8_t * restrict cl,
                          const struct V3D71_SET_INSTANCEID * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_SET_INSTANCEID_length            5
#ifdef __gen_unpack_address
static inline void
V3D71_SET_INSTANCEID_unpack(const uint8_t * restrict cl,
                            struct V3D71_SET_INSTANCEID * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D71_SET_PRIMITIVEID_opcode          55
#define V3D71_SET_PRIMITIVEID_header            \
   .opcode                              =     55

struct V3D71_SET_PRIMITIVEID {
   uint32_t                             opcode;
   uint32_t                             primitive_id;
};

static inline void
V3D71_SET_PRIMITIVEID_pack(__gen_user_data *data, uint8_t * restrict cl,
                           const struct V3D71_SET_PRIMITIVEID * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_SET_PRIMITIVEID_length           5
#ifdef __gen_unpack_address
static inline void
V3D71_SET_PRIMITIVEID_unpack(const uint8_t * restrict cl,
                             struct V3D71_SET_PRIMITIVEID * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D71_PRIM_LIST_FORMAT_opcode         56
#define V3D71_PRIM_LIST_FORMAT_header           \
   .opcode                              =     56

struct V3D71_PRIM_LIST_FORMAT {
   uint32_t                             opcode;
...
static inline void
V3D71_PRIM_LIST_FORMAT_pack(__gen_user_data *data, uint8_t * restrict cl,
                            const struct V3D71_PRIM_LIST_FORMAT * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_PRIM_LIST_FORMAT_length          2
#ifdef __gen_unpack_address
static inline void
V3D71_PRIM_LIST_FORMAT_unpack(const uint8_t * restrict cl,
                              struct V3D71_PRIM_LIST_FORMAT * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D71_SERIAL_NUMBER_LIST_START_opcode     57
#define V3D71_SERIAL_NUMBER_LIST_START_header   \
   .opcode                              =     57

struct V3D71_SERIAL_NUMBER_LIST_START {
   uint32_t                             opcode;
   __gen_address_type                   address;
   uint32_t                             block_size;
...
static inline void
V3D71_SERIAL_NUMBER_LIST_START_pack(__gen_user_data *data, uint8_t * restrict cl,
                                    const struct V3D71_SERIAL_NUMBER_LIST_START * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_SERIAL_NUMBER_LIST_START_length      5
#ifdef __gen_unpack_address
static inline void
V3D71_SERIAL_NUMBER_LIST_START_unpack(const uint8_t * restrict cl,
                                      struct V3D71_SERIAL_NUMBER_LIST_START * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D71_GL_SHADER_STATE_opcode          64
#define V3D71_GL_SHADER_STATE_header            \
   .opcode                              =     64
...
static inline void
V3D71_GL_SHADER_STATE_pack(__gen_user_data *data, uint8_t * restrict cl,
                           const struct V3D71_GL_SHADER_STATE * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#ifdef __gen_unpack_address
static inline void
V3D71_GL_SHADER_STATE_unpack(const uint8_t * restrict cl,
                             struct V3D71_GL_SHADER_STATE * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D71_GL_SHADER_STATE_INCLUDING_TS_opcode     65
#define V3D71_GL_SHADER_STATE_INCLUDING_TS_header\
   .opcode                              =     65

struct V3D71_GL_SHADER_STATE_INCLUDING_TS {
   uint32_t                             opcode;
   __gen_address_type                   address;
   uint32_t                             number_of_attribute_arrays;
};
...
static inline void
V3D71_GL_SHADER_STATE_INCLUDING_TS_pack(__gen_user_data *data, uint8_t * restrict cl,
                                        const struct V3D71_GL_SHADER_STATE_INCLUDING_TS * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_GL_SHADER_STATE_INCLUDING_TS_length      5
#ifdef __gen_unpack_address
static inline void
V3D71_GL_SHADER_STATE_INCLUDING_TS_unpack(const uint8_t * restrict cl,
                                          struct V3D71_GL_SHADER_STATE_INCLUDING_TS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
   values->address = __gen_unpack_address(cl, 13, 39);
   values->number_of_attribute_arrays = __gen_unpack_uint(cl, 8, 12);
...
#define V3D71_GL_SHADER_STATE_INCLUDING_GS_opcode     66
#define V3D71_GL_SHADER_STATE_INCLUDING_GS_header\
   .opcode                              =     66

struct V3D71_GL_SHADER_STATE_INCLUDING_GS {
   uint32_t                             opcode;
   __gen_address_type                   address;
   uint32_t                             number_of_attribute_arrays;
};
...
static inline void
V3D71_GL_SHADER_STATE_INCLUDING_GS_pack(__gen_user_data *data, uint8_t * restrict cl,
                                        const struct V3D71_GL_SHADER_STATE_INCLUDING_GS * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_GL_SHADER_STATE_INCLUDING_GS_length      5
#ifdef __gen_unpack_address
static inline void
V3D71_GL_SHADER_STATE_INCLUDING_GS_unpack(const uint8_t * restrict cl,
                                          struct V3D71_GL_SHADER_STATE_INCLUDING_GS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
   values->address = __gen_unpack_address(cl, 13, 39);
   values->number_of_attribute_arrays = __gen_unpack_uint(cl, 8, 12);
...
#define V3D71_GL_SHADER_STATE_INCLUDING_TS_GS_opcode     67
#define V3D71_GL_SHADER_STATE_INCLUDING_TS_GS_header\
   .opcode                              =     67

struct V3D71_GL_SHADER_STATE_INCLUDING_TS_GS {
   uint32_t                             opcode;
   __gen_address_type                   address;
   uint32_t                             number_of_attribute_arrays;
};
...
static inline void
V3D71_GL_SHADER_STATE_INCLUDING_TS_GS_pack(__gen_user_data *data, uint8_t * restrict cl,
                                           const struct V3D71_GL_SHADER_STATE_INCLUDING_TS_GS * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_GL_SHADER_STATE_INCLUDING_TS_GS_length      5
#ifdef __gen_unpack_address
static inline void
V3D71_GL_SHADER_STATE_INCLUDING_TS_GS_unpack(const uint8_t * restrict cl,
                                             struct V3D71_GL_SHADER_STATE_INCLUDING_TS_GS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
   values->address = __gen_unpack_address(cl, 13, 39);
   values->number_of_attribute_arrays = __gen_unpack_uint(cl, 8, 12);
...
#define V3D71_VCM_CACHE_SIZE_opcode           71
#define V3D71_VCM_CACHE_SIZE_header             \
   .opcode                              =     71

struct V3D71_VCM_CACHE_SIZE {
   uint32_t                             opcode;
...
static inline void
V3D71_VCM_CACHE_SIZE_pack(__gen_user_data *data, uint8_t * restrict cl,
                          const struct V3D71_VCM_CACHE_SIZE * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_VCM_CACHE_SIZE_length            2
#ifdef __gen_unpack_address
static inline void
V3D71_VCM_CACHE_SIZE_unpack(const uint8_t * restrict cl,
                            struct V3D71_VCM_CACHE_SIZE * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D71_PRIMITIVE_COUNTS_FEEDBACK_opcode     72
#define V3D71_PRIMITIVE_COUNTS_FEEDBACK_header  \
   .opcode                              =     72

struct V3D71_PRIMITIVE_COUNTS_FEEDBACK {
   uint32_t                             opcode;
   __gen_address_type                   address;
...
static inline void
V3D71_PRIMITIVE_COUNTS_FEEDBACK_pack(__gen_user_data *data, uint8_t * restrict cl,
                                     const struct V3D71_PRIMITIVE_COUNTS_FEEDBACK * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_PRIMITIVE_COUNTS_FEEDBACK_length      5
#ifdef __gen_unpack_address
static inline void
V3D71_PRIMITIVE_COUNTS_FEEDBACK_unpack(const uint8_t * restrict cl,
                                       struct V3D71_PRIMITIVE_COUNTS_FEEDBACK * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
   values->address = __gen_unpack_address(cl, 13, 39);
...
#define V3D71_TRANSFORM_FEEDBACK_BUFFER_opcode     73
#define V3D71_TRANSFORM_FEEDBACK_BUFFER_header  \
   .opcode                              =     73

struct V3D71_TRANSFORM_FEEDBACK_BUFFER {
   uint32_t                             opcode;
...
static inline void
V3D71_TRANSFORM_FEEDBACK_BUFFER_pack(__gen_user_data *data, uint8_t * restrict cl,
                                     const struct V3D71_TRANSFORM_FEEDBACK_BUFFER * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_TRANSFORM_FEEDBACK_BUFFER_length      9
#ifdef __gen_unpack_address
static inline void
V3D71_TRANSFORM_FEEDBACK_BUFFER_unpack(const uint8_t * restrict cl,
                                       struct V3D71_TRANSFORM_FEEDBACK_BUFFER * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D71_TRANSFORM_FEEDBACK_SPECS_opcode     74
#define V3D71_TRANSFORM_FEEDBACK_SPECS_header   \
   .opcode                              =     74

struct V3D71_TRANSFORM_FEEDBACK_SPECS {
   uint32_t                             opcode;
   bool                                 enable;
...
static inline void
V3D71_TRANSFORM_FEEDBACK_SPECS_pack(__gen_user_data *data, uint8_t * restrict cl,
                                    const struct V3D71_TRANSFORM_FEEDBACK_SPECS * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_TRANSFORM_FEEDBACK_SPECS_length      2
#ifdef __gen_unpack_address
static inline void
V3D71_TRANSFORM_FEEDBACK_SPECS_unpack(const uint8_t * restrict cl,
                                      struct V3D71_TRANSFORM_FEEDBACK_SPECS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D71_FLUSH_TRANSFORM_FEEDBACK_DATA_opcode     75
#define V3D71_FLUSH_TRANSFORM_FEEDBACK_DATA_header\
   .opcode                              =     75

struct V3D71_FLUSH_TRANSFORM_FEEDBACK_DATA {
   uint32_t                             opcode;
};

static inline void
V3D71_FLUSH_TRANSFORM_FEEDBACK_DATA_pack(__gen_user_data *data, uint8_t * restrict cl,
                                         const struct V3D71_FLUSH_TRANSFORM_FEEDBACK_DATA * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);

}

#define V3D71_FLUSH_TRANSFORM_FEEDBACK_DATA_length      1
#ifdef __gen_unpack_address
static inline void
V3D71_FLUSH_TRANSFORM_FEEDBACK_DATA_unpack(const uint8_t * restrict cl,
                                           struct V3D71_FLUSH_TRANSFORM_FEEDBACK_DATA * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D71_L1_CACHE_FLUSH_CONTROL_opcode     76
#define V3D71_L1_CACHE_FLUSH_CONTROL_header     \
   .opcode                              =     76

struct V3D71_L1_CACHE_FLUSH_CONTROL {
   uint32_t                             opcode;
...
static inline void
V3D71_L1_CACHE_FLUSH_CONTROL_pack(__gen_user_data *data, uint8_t * restrict cl,
                                  const struct V3D71_L1_CACHE_FLUSH_CONTROL * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_L1_CACHE_FLUSH_CONTROL_length      3
#ifdef __gen_unpack_address
static inline void
V3D71_L1_CACHE_FLUSH_CONTROL_unpack(const uint8_t * restrict cl,
                                    struct V3D71_L1_CACHE_FLUSH_CONTROL * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D71_L2T_CACHE_FLUSH_CONTROL_opcode     77
#define V3D71_L2T_CACHE_FLUSH_CONTROL_header    \
   .opcode                              =     77

struct V3D71_L2T_CACHE_FLUSH_CONTROL {
   uint32_t                             opcode;
   enum V3D71_L2T_Flush_Mode            l2t_flush_mode;
   __gen_address_type                   l2t_flush_end;
   __gen_address_type                   l2t_flush_start;
};

static inline void
V3D71_L2T_CACHE_FLUSH_CONTROL_pack(__gen_user_data *data, uint8_t * restrict cl,
                                   const struct V3D71_L2T_CACHE_FLUSH_CONTROL * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_L2T_CACHE_FLUSH_CONTROL_length     10
#ifdef __gen_unpack_address
static inline void
V3D71_L2T_CACHE_FLUSH_CONTROL_unpack(const uint8_t * restrict cl,
                                     struct V3D71_L2T_CACHE_FLUSH_CONTROL * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D71_TRANSFORM_FEEDBACK_OUTPUT_DATA_SPEC_header\


struct V3D71_TRANSFORM_FEEDBACK_OUTPUT_DATA_SPEC {
...
static inline void
V3D71_TRANSFORM_FEEDBACK_OUTPUT_DATA_SPEC_pack(__gen_user_data *data, uint8_t * restrict cl,
                                               const struct V3D71_TRANSFORM_FEEDBACK_OUTPUT_DATA_SPEC * restrict values)
{
...
#define V3D71_TRANSFORM_FEEDBACK_OUTPUT_DATA_SPEC_length      2
#ifdef __gen_unpack_address
static inline void
V3D71_TRANSFORM_FEEDBACK_OUTPUT_DATA_SPEC_unpack(const uint8_t * restrict cl,
                                                 struct V3D71_TRANSFORM_FEEDBACK_OUTPUT_DATA_SPEC * restrict values)
{
...
#define V3D71_TRANSFORM_FEEDBACK_OUTPUT_ADDRESS_header\


struct V3D71_TRANSFORM_FEEDBACK_OUTPUT_ADDRESS {
   __gen_address_type                   address;
};

static inline void
V3D71_TRANSFORM_FEEDBACK_OUTPUT_ADDRESS_pack(__gen_user_data *data, uint8_t * restrict cl,
                                             const struct V3D71_TRANSFORM_FEEDBACK_OUTPUT_ADDRESS * restrict values)
{
   __gen_emit_reloc(data, &values->address);
...
#define V3D71_TRANSFORM_FEEDBACK_OUTPUT_ADDRESS_length      4
#ifdef __gen_unpack_address
static inline void
V3D71_TRANSFORM_FEEDBACK_OUTPUT_ADDRESS_unpack(const uint8_t * restrict cl,
                                               struct V3D71_TRANSFORM_FEEDBACK_OUTPUT_ADDRESS * restrict values)
{
...
#define V3D71_STENCIL_CFG_opcode              80
#define V3D71_STENCIL_CFG_header                \
   .opcode                              =     80

struct V3D71_STENCIL_CFG {
   uint32_t                             opcode;
   uint32_t                             stencil_write_mask;
   bool                                 back_config;
   bool                                 front_config;
   enum V3D71_Stencil_Op                stencil_pass_op;
   enum V3D71_Stencil_Op                depth_test_fail_op;
   enum V3D71_Stencil_Op                stencil_test_fail_op;
   enum V3D71_Compare_Function          stencil_test_function;
   uint32_t                             stencil_test_mask;
   uint32_t                             stencil_ref_value;
};

static inline void
V3D71_STENCIL_CFG_pack(__gen_user_data *data, uint8_t * restrict cl,
                       const struct V3D71_STENCIL_CFG * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_STENCIL_CFG_length               6
#ifdef __gen_unpack_address
static inline void
V3D71_STENCIL_CFG_unpack(const uint8_t * restrict cl,
                         struct V3D71_STENCIL_CFG * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D71_BLEND_ENABLES_opcode            83
#define V3D71_BLEND_ENABLES_header              \
   .opcode                              =     83

struct V3D71_BLEND_ENABLES {
   uint32_t                             opcode;
   uint32_t                             mask;
};

static inline void
V3D71_BLEND_ENABLES_pack(__gen_user_data *data, uint8_t * restrict cl,
                         const struct V3D71_BLEND_ENABLES * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_BLEND_ENABLES_length             2
#ifdef __gen_unpack_address
static inline void
V3D71_BLEND_ENABLES_unpack(const uint8_t * restrict cl,
                           struct V3D71_BLEND_ENABLES * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D71_BLEND_CFG_opcode                84
#define V3D71_BLEND_CFG_header                  \
   .opcode                              =     84

struct V3D71_BLEND_CFG {
   uint32_t                             opcode;
   uint32_t                             render_target_mask;
   enum V3D71_Blend_Factor              color_blend_dst_factor;
   enum V3D71_Blend_Factor              color_blend_src_factor;
   enum V3D71_Blend_Mode                color_blend_mode;
   enum V3D71_Blend_Factor              alpha_blend_dst_factor;
   enum V3D71_Blend_Factor              alpha_blend_src_factor;
   enum V3D71_Blend_Mode                alpha_blend_mode;
};

static inline void
V3D71_BLEND_CFG_pack(__gen_user_data *data, uint8_t * restrict cl,
                     const struct V3D71_BLEND_CFG * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
   ...
   cl[ 4] = util_bitpack_uint(values->render_target_mask, 0, 7);

}

#define V3D71_BLEND_CFG_length                 5
#ifdef __gen_unpack_address
static inline void
V3D71_BLEND_CFG_unpack(const uint8_t * restrict cl,
                       struct V3D71_BLEND_CFG * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
   values->render_target_mask = __gen_unpack_uint(cl, 32, 39);
...
#define V3D71_BLEND_CONSTANT_COLOR_opcode     86
#define V3D71_BLEND_CONSTANT_COLOR_header       \
   .opcode                              =     86

struct V3D71_BLEND_CONSTANT_COLOR {
   uint32_t                             opcode;
   uint32_t                             alpha_f16;
   uint32_t                             blue_f16;
   uint32_t                             green_f16;
...
static inline void
V3D71_BLEND_CONSTANT_COLOR_pack(__gen_user_data *data, uint8_t * restrict cl,
                                const struct V3D71_BLEND_CONSTANT_COLOR * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_BLEND_CONSTANT_COLOR_length      9
#ifdef __gen_unpack_address
static inline void
V3D71_BLEND_CONSTANT_COLOR_unpack(const uint8_t * restrict cl,
                                  struct V3D71_BLEND_CONSTANT_COLOR * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D71_COLOR_WRITE_MASKS_opcode        87
#define V3D71_COLOR_WRITE_MASKS_header          \
   .opcode                              =     87

struct V3D71_COLOR_WRITE_MASKS {
   uint32_t                             opcode;
   uint32_t                             mask;
};

static inline void
V3D71_COLOR_WRITE_MASKS_pack(__gen_user_data *data, uint8_t * restrict cl,
                             const struct V3D71_COLOR_WRITE_MASKS * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_COLOR_WRITE_MASKS_length         5
#ifdef __gen_unpack_address
static inline void
V3D71_COLOR_WRITE_MASKS_unpack(const uint8_t * restrict cl,
                               struct V3D71_COLOR_WRITE_MASKS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D71_ZERO_ALL_CENTROID_FLAGS_opcode     88
#define V3D71_ZERO_ALL_CENTROID_FLAGS_header    \
   .opcode                              =     88

struct V3D71_ZERO_ALL_CENTROID_FLAGS {
   uint32_t                             opcode;
};

static inline void
V3D71_ZERO_ALL_CENTROID_FLAGS_pack(__gen_user_data *data, uint8_t * restrict cl,
                                   const struct V3D71_ZERO_ALL_CENTROID_FLAGS * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);

}

#define V3D71_ZERO_ALL_CENTROID_FLAGS_length      1
#ifdef __gen_unpack_address
static inline void
V3D71_ZERO_ALL_CENTROID_FLAGS_unpack(const uint8_t * restrict cl,
                                     struct V3D71_ZERO_ALL_CENTROID_FLAGS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D71_CENTROID_FLAGS_opcode           89
#define V3D71_CENTROID_FLAGS_header             \
   .opcode                              =     89

struct V3D71_CENTROID_FLAGS {
   uint32_t                             opcode;
   uint32_t                             centroid_flags_for_varyings_v024;
   enum V3D71_Varying_Flags_Action      action_for_centroid_flags_of_higher_numbered_varyings;
   enum V3D71_Varying_Flags_Action      action_for_centroid_flags_of_lower_numbered_varyings;
   uint32_t                             varying_offset_v0;
};

static inline void
V3D71_CENTROID_FLAGS_pack(__gen_user_data *data, uint8_t * restrict cl,
                          const struct V3D71_CENTROID_FLAGS * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_CENTROID_FLAGS_length            5
#ifdef __gen_unpack_address
static inline void
V3D71_CENTROID_FLAGS_unpack(const uint8_t * restrict cl,
                            struct V3D71_CENTROID_FLAGS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D71_SAMPLE_STATE_opcode             91
#define V3D71_SAMPLE_STATE_header               \
   .opcode                              =     91

struct V3D71_SAMPLE_STATE {
   uint32_t                             opcode;
   float                                coverage;
   uint32_t                             mask;
};
...
static inline void
V3D71_SAMPLE_STATE_pack(__gen_user_data *data, uint8_t * restrict cl,
                        const struct V3D71_SAMPLE_STATE * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_SAMPLE_STATE_length              5
#ifdef __gen_unpack_address
static inline void
V3D71_SAMPLE_STATE_unpack(const uint8_t * restrict cl,
                          struct V3D71_SAMPLE_STATE * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D71_OCCLUSION_QUERY_COUNTER_opcode     92
#define V3D71_OCCLUSION_QUERY_COUNTER_header    \
   .opcode                              =     92

struct V3D71_OCCLUSION_QUERY_COUNTER {
   uint32_t                             opcode;
   __gen_address_type                   address;
};

static inline void
V3D71_OCCLUSION_QUERY_COUNTER_pack(__gen_user_data *data, uint8_t * restrict cl,
                                   const struct V3D71_OCCLUSION_QUERY_COUNTER * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_OCCLUSION_QUERY_COUNTER_length      5
#ifdef __gen_unpack_address
static inline void
V3D71_OCCLUSION_QUERY_COUNTER_unpack(const uint8_t * restrict cl,
                                     struct V3D71_OCCLUSION_QUERY_COUNTER * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
   values->address = __gen_unpack_address(cl, 8, 39);
}
...
#define V3D71_DEPTH_BOUNDS_TEST_LIMITS_opcode     93
#define V3D71_DEPTH_BOUNDS_TEST_LIMITS_header   \
   .opcode                              =     93

struct V3D71_DEPTH_BOUNDS_TEST_LIMITS {
   uint32_t                             opcode;
   float                                lower_test_limit;
   float                                upper_test_limit;
};

static inline void
V3D71_DEPTH_BOUNDS_TEST_LIMITS_pack(__gen_user_data *data, uint8_t * restrict cl,
                                    const struct V3D71_DEPTH_BOUNDS_TEST_LIMITS * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);


   memcpy(&cl[1], &values->lower_test_limit, sizeof(values->lower_test_limit));

   memcpy(&cl[5], &values->upper_test_limit, sizeof(values->upper_test_limit));
}

#define V3D71_DEPTH_BOUNDS_TEST_LIMITS_length      9
#ifdef __gen_unpack_address
static inline void
V3D71_DEPTH_BOUNDS_TEST_LIMITS_unpack(const uint8_t * restrict cl,
                                      struct V3D71_DEPTH_BOUNDS_TEST_LIMITS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
   values->lower_test_limit = __gen_unpack_float(cl, 8, 39);
   values->upper_test_limit = __gen_unpack_float(cl, 40, 71);
}
#endif


#define V3D71_CFG_BITS_opcode                 96
#define V3D71_CFG_BITS_header                   \
   .opcode                              =     96

struct V3D71_CFG_BITS {
   uint32_t                             opcode;
   enum V3D71_Z_Clip_Mode               z_clipping_mode;
   bool                                 direct3d_provoking_vertex;
   bool                                 direct3d_point_fill_mode;
   bool                                 blend_enable;
   bool                                 stencil_enable;
   bool                                 z_updates_enable;
   enum V3D71_Compare_Function          depth_test_function;
...
static inline void
V3D71_CFG_BITS_pack(__gen_user_data *data, uint8_t * restrict cl,
                    const struct V3D71_CFG_BITS * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);

   cl[ 1] = util_bitpack_uint(values->rasterizer_oversample_mode, 6, 7) |
            util_bitpack_uint(values->depth_bounds_test_enable, 5, 5) |
            util_bitpack_uint(values->line_rasterization, 4, 4) |
   ...
   cl[ 2] = util_bitpack_uint(values->z_updates_enable, 7, 7) |
            ...
            util_bitpack_uint(values->z_clamp_mode, 2, 2);

   cl[ 3] = util_bitpack_uint(values->z_clipping_mode, 6, 7) |
            util_bitpack_uint(values->direct3d_provoking_vertex, 5, 5) |
...
#define V3D71_CFG_BITS_length                  4
#ifdef __gen_unpack_address
static inline void
V3D71_CFG_BITS_unpack(const uint8_t * restrict cl,
                      struct V3D71_CFG_BITS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
   values->z_clipping_mode = __gen_unpack_uint(cl, 30, 31);
   ...
   values->z_clamp_mode = __gen_unpack_uint(cl, 18, 18);
   values->rasterizer_oversample_mode = __gen_unpack_uint(cl, 14, 15);
   values->depth_bounds_test_enable = __gen_unpack_uint(cl, 13, 13);
   values->line_rasterization = __gen_unpack_uint(cl, 12, 12);
...
#define V3D71_ZERO_ALL_FLAT_SHADE_FLAGS_opcode     97
#define V3D71_ZERO_ALL_FLAT_SHADE_FLAGS_header  \
   .opcode                              =     97

struct V3D71_ZERO_ALL_FLAT_SHADE_FLAGS {
   uint32_t                             opcode;
};

static inline void
V3D71_ZERO_ALL_FLAT_SHADE_FLAGS_pack(__gen_user_data *data, uint8_t * restrict cl,
                                     const struct V3D71_ZERO_ALL_FLAT_SHADE_FLAGS * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);

}

#define V3D71_ZERO_ALL_FLAT_SHADE_FLAGS_length      1
#ifdef __gen_unpack_address
static inline void
V3D71_ZERO_ALL_FLAT_SHADE_FLAGS_unpack(const uint8_t * restrict cl,
                                       struct V3D71_ZERO_ALL_FLAT_SHADE_FLAGS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D71_FLAT_SHADE_FLAGS_opcode         98
#define V3D71_FLAT_SHADE_FLAGS_header           \
   .opcode                              =     98

struct V3D71_FLAT_SHADE_FLAGS {
   uint32_t                             opcode;
   uint32_t                             flat_shade_flags_for_varyings_v024;
   enum V3D71_Varying_Flags_Action      action_for_flat_shade_flags_of_higher_numbered_varyings;
   enum V3D71_Varying_Flags_Action      action_for_flat_shade_flags_of_lower_numbered_varyings;
   uint32_t                             varying_offset_v0;
};

static inline void
V3D71_FLAT_SHADE_FLAGS_pack(__gen_user_data *data, uint8_t * restrict cl,
                            const struct V3D71_FLAT_SHADE_FLAGS * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_FLAT_SHADE_FLAGS_length          5
#ifdef __gen_unpack_address
static inline void
V3D71_FLAT_SHADE_FLAGS_unpack(const uint8_t * restrict cl,
                              struct V3D71_FLAT_SHADE_FLAGS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D71_ZERO_ALL_NON_PERSPECTIVE_FLAGS_opcode     99
#define V3D71_ZERO_ALL_NON_PERSPECTIVE_FLAGS_header\
   .opcode                              =     99

struct V3D71_ZERO_ALL_NON_PERSPECTIVE_FLAGS {
   uint32_t                             opcode;
};

static inline void
V3D71_ZERO_ALL_NON_PERSPECTIVE_FLAGS_pack(__gen_user_data *data, uint8_t * restrict cl,
                                          const struct V3D71_ZERO_ALL_NON_PERSPECTIVE_FLAGS * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);

}

#define V3D71_ZERO_ALL_NON_PERSPECTIVE_FLAGS_length      1
#ifdef __gen_unpack_address
static inline void
V3D71_ZERO_ALL_NON_PERSPECTIVE_FLAGS_unpack(const uint8_t * restrict cl,
                                            struct V3D71_ZERO_ALL_NON_PERSPECTIVE_FLAGS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D71_NON_PERSPECTIVE_FLAGS_opcode    100
#define V3D71_NON_PERSPECTIVE_FLAGS_header      \
   .opcode                              =    100

struct V3D71_NON_PERSPECTIVE_FLAGS {
   uint32_t                             opcode;
   uint32_t                             non_perspective_flags_for_varyings_v024;
   enum V3D71_Varying_Flags_Action      action_for_non_perspective_flags_of_higher_numbered_varyings;
   enum V3D71_Varying_Flags_Action      action_for_non_perspective_flags_of_lower_numbered_varyings;
   uint32_t                             varying_offset_v0;
};

static inline void
V3D71_NON_PERSPECTIVE_FLAGS_pack(__gen_user_data *data, uint8_t * restrict cl,
                                 const struct V3D71_NON_PERSPECTIVE_FLAGS * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_NON_PERSPECTIVE_FLAGS_length      5
#ifdef __gen_unpack_address
static inline void
V3D71_NON_PERSPECTIVE_FLAGS_unpack(const uint8_t * restrict cl,
                                   struct V3D71_NON_PERSPECTIVE_FLAGS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D71_POINT_SIZE_opcode              104
#define V3D71_POINT_SIZE_header                 \
   .opcode                              =    104

struct V3D71_POINT_SIZE {
   uint32_t                             opcode;
   float                                point_size;
};

static inline void
V3D71_POINT_SIZE_pack(__gen_user_data *data, uint8_t * restrict cl,
                      const struct V3D71_POINT_SIZE * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_POINT_SIZE_length                5
#ifdef __gen_unpack_address
static inline void
V3D71_POINT_SIZE_unpack(const uint8_t * restrict cl,
                        struct V3D71_POINT_SIZE * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D71_LINE_WIDTH_opcode              105
#define V3D71_LINE_WIDTH_header                 \
   .opcode                              =    105

struct V3D71_LINE_WIDTH {
   uint32_t                             opcode;
   float                                line_width;
};

static inline void
V3D71_LINE_WIDTH_pack(__gen_user_data *data, uint8_t * restrict cl,
                      const struct V3D71_LINE_WIDTH * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_LINE_WIDTH_length                5
#ifdef __gen_unpack_address
static inline void
V3D71_LINE_WIDTH_unpack(const uint8_t * restrict cl,
                        struct V3D71_LINE_WIDTH * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D71_DEPTH_OFFSET_opcode            106
#define V3D71_DEPTH_OFFSET_header               \
   .opcode                              =    106

struct V3D71_DEPTH_OFFSET {
   uint32_t                             opcode;
   float                                limit;
...
static inline void
V3D71_DEPTH_OFFSET_pack(__gen_user_data *data, uint8_t * restrict cl,
                        const struct V3D71_DEPTH_OFFSET * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_DEPTH_OFFSET_length              9
#ifdef __gen_unpack_address
static inline void
V3D71_DEPTH_OFFSET_unpack(const uint8_t * restrict cl,
                          struct V3D71_DEPTH_OFFSET * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D71_CLIP_WINDOW_opcode             107
#define V3D71_CLIP_WINDOW_header                \
   .opcode                              =    107

struct V3D71_CLIP_WINDOW {
   uint32_t                             opcode;
...
static inline void
V3D71_CLIP_WINDOW_pack(__gen_user_data *data, uint8_t * restrict cl,
                       const struct V3D71_CLIP_WINDOW * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_CLIP_WINDOW_length               9
#ifdef __gen_unpack_address
static inline void
V3D71_CLIP_WINDOW_unpack(const uint8_t * restrict cl,
                         struct V3D71_CLIP_WINDOW * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D71_VIEWPORT_OFFSET_opcode         108
#define V3D71_VIEWPORT_OFFSET_header            \
   .opcode                              =    108

struct V3D71_VIEWPORT_OFFSET {
   uint32_t                             opcode;
   int32_t                              coarse_y;
   float                                fine_y;
   int32_t                              coarse_x;
...
static inline void
V3D71_VIEWPORT_OFFSET_pack(__gen_user_data *data, uint8_t * restrict cl,
                           const struct V3D71_VIEWPORT_OFFSET * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);

   cl[ 1] = util_bitpack_ufixed(values->fine_x, 0, 21, 8);

   cl[ 2] = util_bitpack_ufixed(values->fine_x, 0, 21, 8) >> 8;

   cl[ 3] = util_bitpack_sint(values->coarse_x, 6, 15) |
            util_bitpack_ufixed(values->fine_x, 0, 21, 8) >> 16;

   cl[ 4] = util_bitpack_sint(values->coarse_x, 6, 15) >> 8;

   cl[ 5] = util_bitpack_ufixed(values->fine_y, 0, 21, 8);

   cl[ 6] = util_bitpack_ufixed(values->fine_y, 0, 21, 8) >> 8;

   cl[ 7] = util_bitpack_sint(values->coarse_y, 6, 15) |
            util_bitpack_ufixed(values->fine_y, 0, 21, 8) >> 16;

   cl[ 8] = util_bitpack_sint(values->coarse_y, 6, 15) >> 8;

}

#define V3D71_VIEWPORT_OFFSET_length           9
#ifdef __gen_unpack_address
static inline void
V3D71_VIEWPORT_OFFSET_unpack(const uint8_t * restrict cl,
                             struct V3D71_VIEWPORT_OFFSET * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
   values->coarse_y = __gen_unpack_sint(cl, 62, 71);
   values->fine_y = __gen_unpack_ufixed(cl, 40, 61, 8);
   values->coarse_x = __gen_unpack_sint(cl, 30, 39);
   values->fine_x = __gen_unpack_ufixed(cl, 8, 29, 8);
}
#endif


#define V3D71_CLIPPER_Z_MIN_MAX_CLIPPING_PLANES_opcode    109
#define V3D71_CLIPPER_Z_MIN_MAX_CLIPPING_PLANES_header\
   .opcode                              =    109

struct V3D71_CLIPPER_Z_MIN_MAX_CLIPPING_PLANES {
   uint32_t                             opcode;
   float                                maximum_zw;
   float                                minimum_zw;
};
...
static inline void
V3D71_CLIPPER_Z_MIN_MAX_CLIPPING_PLANES_pack(__gen_user_data *data, uint8_t * restrict cl,
                                             const struct V3D71_CLIPPER_Z_MIN_MAX_CLIPPING_PLANES * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_CLIPPER_Z_MIN_MAX_CLIPPING_PLANES_length      9
#ifdef __gen_unpack_address
static inline void
V3D71_CLIPPER_Z_MIN_MAX_CLIPPING_PLANES_unpack(const uint8_t * restrict cl,
                                               struct V3D71_CLIPPER_Z_MIN_MAX_CLIPPING_PLANES * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D71_CLIPPER_XY_SCALING_opcode      110
#define V3D71_CLIPPER_XY_SCALING_header         \
   .opcode                              =    110

struct V3D71_CLIPPER_XY_SCALING {
   uint32_t                             opcode;
   float                                viewport_half_height_in_1_64th_of_pixel;
   float                                viewport_half_width_in_1_64th_of_pixel;
};

static inline void
V3D71_CLIPPER_XY_SCALING_pack(__gen_user_data *data, uint8_t * restrict cl,
                              const struct V3D71_CLIPPER_XY_SCALING * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);


   memcpy(&cl[1], &values->viewport_half_width_in_1_64th_of_pixel, sizeof(values->viewport_half_width_in_1_64th_of_pixel));

   memcpy(&cl[5], &values->viewport_half_height_in_1_64th_of_pixel, sizeof(values->viewport_half_height_in_1_64th_of_pixel));
}

#define V3D71_CLIPPER_XY_SCALING_length        9
#ifdef __gen_unpack_address
static inline void
V3D71_CLIPPER_XY_SCALING_unpack(const uint8_t * restrict cl,
                                struct V3D71_CLIPPER_XY_SCALING * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
   values->viewport_half_height_in_1_64th_of_pixel = __gen_unpack_float(cl, 40, 71);
   values->viewport_half_width_in_1_64th_of_pixel = __gen_unpack_float(cl, 8, 39);
}
#endif


#define V3D71_CLIPPER_Z_SCALE_AND_OFFSET_opcode    111
#define V3D71_CLIPPER_Z_SCALE_AND_OFFSET_header \
   .opcode                              =    111

struct V3D71_CLIPPER_Z_SCALE_AND_OFFSET {
   uint32_t                             opcode;
...
static inline void
V3D71_CLIPPER_Z_SCALE_AND_OFFSET_pack(__gen_user_data *data, uint8_t * restrict cl,
                                      const struct V3D71_CLIPPER_Z_SCALE_AND_OFFSET * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_CLIPPER_Z_SCALE_AND_OFFSET_length      9
#ifdef __gen_unpack_address
static inline void
V3D71_CLIPPER_Z_SCALE_AND_OFFSET_unpack(const uint8_t * restrict cl,
                                        struct V3D71_CLIPPER_Z_SCALE_AND_OFFSET * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D71_CLIPPER_Z_SCALE_AND_OFFSET_NO_GUARDBAND_opcode    112
#define V3D71_CLIPPER_Z_SCALE_AND_OFFSET_NO_GUARDBAND_header\
   .opcode                              =    112

struct V3D71_CLIPPER_Z_SCALE_AND_OFFSET_NO_GUARDBAND {
   uint32_t                             opcode;
   float                                viewport_z_offset_zc_to_zs;
   float                                viewport_z_scale_zc_to_zs;
};
...
static inline void
V3D71_CLIPPER_Z_SCALE_AND_OFFSET_NO_GUARDBAND_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                   const struct V3D71_CLIPPER_Z_SCALE_AND_OFFSET_NO_GUARDBAND * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_CLIPPER_Z_SCALE_AND_OFFSET_NO_GUARDBAND_length      9
#ifdef __gen_unpack_address
static inline void
V3D71_CLIPPER_Z_SCALE_AND_OFFSET_NO_GUARDBAND_unpack(const uint8_t * restrict cl,
                                                     struct V3D71_CLIPPER_Z_SCALE_AND_OFFSET_NO_GUARDBAND * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
   values->viewport_z_offset_zc_to_zs = __gen_unpack_float(cl, 40, 71);
   values->viewport_z_scale_zc_to_zs = __gen_unpack_float(cl, 8, 39);
...
#define V3D71_NUMBER_OF_LAYERS_opcode        119
#define V3D71_NUMBER_OF_LAYERS_header           \
   .opcode                              =    119

struct V3D71_NUMBER_OF_LAYERS {
   uint32_t                             opcode;
   uint32_t                             number_of_layers;
};

static inline void
V3D71_NUMBER_OF_LAYERS_pack(__gen_user_data *data, uint8_t * restrict cl,
                            const struct V3D71_NUMBER_OF_LAYERS * restrict values)
{
...
#define V3D71_NUMBER_OF_LAYERS_length          2
#ifdef __gen_unpack_address
static inline void
V3D71_NUMBER_OF_LAYERS_unpack(const uint8_t * restrict cl,
                              struct V3D71_NUMBER_OF_LAYERS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D71_TILE_BINNING_MODE_CFG_opcode    120
#define V3D71_TILE_BINNING_MODE_CFG_header      \
   .opcode                              =    120
...
struct V3D71_TILE_BINNING_MODE_CFG {
   ...
   uint32_t                             log2_tile_height;
#define TILE_HEIGHT_8_PIXELS                     0
#define TILE_HEIGHT_16_PIXELS                    1
#define TILE_HEIGHT_32_PIXELS                    2
#define TILE_HEIGHT_64_PIXELS                    3
   uint32_t                             log2_tile_width;
#define TILE_WIDTH_8_PIXELS                      0
#define TILE_WIDTH_16_PIXELS                     1
#define TILE_WIDTH_32_PIXELS                     2
#define TILE_WIDTH_64_PIXELS                     3
...
static inline void
V3D71_TILE_BINNING_MODE_CFG_pack(__gen_user_data *data, uint8_t * restrict cl,
                                 const struct V3D71_TILE_BINNING_MODE_CFG * restrict values)
{
   assert(values->log2_tile_width == values->log2_tile_height ||
          values->log2_tile_width == values->log2_tile_height + 1);
   ...
   cl[ 2] = util_bitpack_uint(values->log2_tile_height, 3, 5) |
            util_bitpack_uint(values->log2_tile_width, 0, 2);
...
#ifdef __gen_unpack_address
static inline void
V3D71_TILE_BINNING_MODE_CFG_unpack(const uint8_t * restrict cl,
                                   struct V3D71_TILE_BINNING_MODE_CFG * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
   values->height_in_pixels = __gen_unpack_uint(cl, 56, 71) + 1;
   values->width_in_pixels = __gen_unpack_uint(cl, 40, 55) + 1;
   values->log2_tile_height = __gen_unpack_uint(cl, 19, 21);
   values->log2_tile_width = __gen_unpack_uint(cl, 16, 18);
...
#define V3D71_TILE_RENDERING_MODE_CFG_COMMON_opcode    121
#define V3D71_TILE_RENDERING_MODE_CFG_COMMON_header\
   .opcode                              =    121,  \
   .sub_id                              =      0
...
#define TILE_WIDTH_64_PIXELS                     3
   ...
   enum V3D71_Internal_Depth_Type       internal_depth_type;
...
static inline void
V3D71_TILE_RENDERING_MODE_CFG_COMMON_pack(__gen_user_data *data, uint8_t * restrict cl,
                                          const struct V3D71_TILE_RENDERING_MODE_CFG_COMMON * restrict values)
{
   assert(values->log2_tile_width == values->log2_tile_height ||
          values->log2_tile_width == values->log2_tile_height + 1);
   ...
   cl[ 1] = util_bitpack_uint(values->number_of_render_targets - 1, 4, 7) |
            util_bitpack_uint(values->sub_id, 0, 2);
   ...
   cl[ 6] = util_bitpack_uint(values->internal_depth_type, 7, 10) |
            ...
            util_bitpack_uint(values->depth_buffer_disable, 4, 4) |
            util_bitpack_uint(values->double_buffer_in_non_ms_mode, 3, 3) |
            util_bitpack_uint(values->multisample_mode_4x, 2, 2);

   cl[ 7] = util_bitpack_uint(values->log2_tile_height, 7, 9) |
            util_bitpack_uint(values->log2_tile_width, 4, 6) |
            util_bitpack_uint(values->early_depth_stencil_clear, 3, 3) |
            util_bitpack_uint(values->internal_depth_type, 7, 10) >> 8;

   cl[ 8] = util_bitpack_uint(values->pad, 2, 7) |
            util_bitpack_uint(values->log2_tile_height, 7, 9) >> 8;

}

#define V3D71_TILE_RENDERING_MODE_CFG_COMMON_length      9
#ifdef __gen_unpack_address
static inline void
V3D71_TILE_RENDERING_MODE_CFG_COMMON_unpack(const uint8_t * restrict cl,
                                            struct V3D71_TILE_RENDERING_MODE_CFG_COMMON * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
   values->pad = __gen_unpack_uint(cl, 66, 71);
   values->log2_tile_height = __gen_unpack_uint(cl, 63, 65);
   values->log2_tile_width = __gen_unpack_uint(cl, 60, 62);
   ...
   values->depth_buffer_disable = __gen_unpack_uint(cl, 52, 52);
   ...
   values->sub_id = __gen_unpack_uint(cl, 8, 10);
}
#endif


#define V3D71_TILE_RENDERING_MODE_CFG_ZS_CLEAR_VALUES_opcode    121
#define V3D71_TILE_RENDERING_MODE_CFG_ZS_CLEAR_VALUES_header\
   .opcode                              =    121,  \
   .sub_id                              =      1
...
static inline void
V3D71_TILE_RENDERING_MODE_CFG_ZS_CLEAR_VALUES_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                   const struct V3D71_TILE_RENDERING_MODE_CFG_ZS_CLEAR_VALUES * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_TILE_RENDERING_MODE_CFG_ZS_CLEAR_VALUES_length      9
#ifdef __gen_unpack_address
static inline void
V3D71_TILE_RENDERING_MODE_CFG_ZS_CLEAR_VALUES_unpack(const uint8_t * restrict cl,
                                                     struct V3D71_TILE_RENDERING_MODE_CFG_ZS_CLEAR_VALUES * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D71_TILE_RENDERING_MODE_CFG_RENDER_TARGET_PART1_opcode    121
#define V3D71_TILE_RENDERING_MODE_CFG_RENDER_TARGET_PART1_header\
   .opcode                              =    121,  \
   .sub_id                              =      2

struct V3D71_TILE_RENDERING_MODE_CFG_RENDER_TARGET_PART1 {
   uint32_t                             opcode;
   uint32_t                             clear_color_low_bits;
   enum V3D71_Render_Target_Type_Clamp  internal_type_and_clamping;
   enum V3D71_Internal_BPP              internal_bpp;
   uint32_t                             stride;
...
static inline void
V3D71_TILE_RENDERING_MODE_CFG_RENDER_TARGET_PART1_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                       const struct V3D71_TILE_RENDERING_MODE_CFG_RENDER_TARGET_PART1 * restrict values)
{
   assert(values->stride >= 1);
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);

   cl[ 1] = util_bitpack_uint(values->base_address, 7, 17) |
            util_bitpack_uint(values->render_target_number, 3, 5) |
            util_bitpack_uint(values->sub_id, 0, 2);

   cl[ 2] = util_bitpack_uint(values->base_address, 7, 17) >> 8;

   cl[ 3] = util_bitpack_uint(values->stride - 1, 2, 8) |
            util_bitpack_uint(values->base_address, 7, 17) >> 16;

   cl[ 4] = util_bitpack_uint(values->internal_type_and_clamping, 3, 7) |
            util_bitpack_uint(values->internal_bpp, 1, 2) |
            util_bitpack_uint(values->stride - 1, 2, 8) >> 8;


   memcpy(&cl[5], &values->clear_color_low_bits, sizeof(values->clear_color_low_bits));
}

#define V3D71_TILE_RENDERING_MODE_CFG_RENDER_TARGET_PART1_length      9
#ifdef __gen_unpack_address
static inline void
V3D71_TILE_RENDERING_MODE_CFG_RENDER_TARGET_PART1_unpack(const uint8_t * restrict cl,
                                                         struct V3D71_TILE_RENDERING_MODE_CFG_RENDER_TARGET_PART1 * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
   values->clear_color_low_bits = __gen_unpack_uint(cl, 40, 71);
   values->internal_type_and_clamping = __gen_unpack_uint(cl, 35, 39);
   values->internal_bpp = __gen_unpack_uint(cl, 33, 34);
   values->stride = __gen_unpack_uint(cl, 26, 32) + 1;
   values->base_address = __gen_unpack_uint(cl, 15, 25);
   values->render_target_number = __gen_unpack_uint(cl, 11, 13);
   values->sub_id = __gen_unpack_uint(cl, 8, 10);
}
#endif


#define V3D71_TILE_RENDERING_MODE_CFG_RENDER_TARGET_PART2_opcode    121
#define V3D71_TILE_RENDERING_MODE_CFG_RENDER_TARGET_PART2_header\
   .opcode                              =    121,  \
   .sub_id                              =      3

struct V3D71_TILE_RENDERING_MODE_CFG_RENDER_TARGET_PART2 {
   uint32_t                             opcode;
   uint64_t                             clear_color_mid_bits;
   uint32_t                             render_target_number;
   uint32_t                             sub_id;
};

static inline void
V3D71_TILE_RENDERING_MODE_CFG_RENDER_TARGET_PART2_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                       const struct V3D71_TILE_RENDERING_MODE_CFG_RENDER_TARGET_PART2 * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);

   cl[ 1] = util_bitpack_uint(values->render_target_number, 3, 5) |
            util_bitpack_uint(values->sub_id, 0, 2);

   cl[ 2] = 0;
   cl[ 3] = 0;
   cl[ 4] = util_bitpack_uint(values->clear_color_mid_bits, 0, 39);

   cl[ 5] = util_bitpack_uint(values->clear_color_mid_bits, 0, 39) >> 8;

   cl[ 6] = util_bitpack_uint(values->clear_color_mid_bits, 0, 39) >> 16;

   cl[ 7] = util_bitpack_uint(values->clear_color_mid_bits, 0, 39) >> 24;

   cl[ 8] = util_bitpack_uint(values->clear_color_mid_bits, 0, 39) >> 32;

}

#define V3D71_TILE_RENDERING_MODE_CFG_RENDER_TARGET_PART2_length      9
#ifdef __gen_unpack_address
static inline void
V3D71_TILE_RENDERING_MODE_CFG_RENDER_TARGET_PART2_unpack(const uint8_t * restrict cl,
                                                         struct V3D71_TILE_RENDERING_MODE_CFG_RENDER_TARGET_PART2 * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
   values->clear_color_mid_bits = __gen_unpack_uint(cl, 32, 71);
   values->render_target_number = __gen_unpack_uint(cl, 11, 13);
   values->sub_id = __gen_unpack_uint(cl, 8, 10);
}
#endif
...
#define V3D71_TILE_RENDERING_MODE_CFG_RENDER_TARGET_PART3_opcode    121
#define V3D71_TILE_RENDERING_MODE_CFG_RENDER_TARGET_PART3_header\
   .opcode                              =    121,  \
   .sub_id                              =      4

struct V3D71_TILE_RENDERING_MODE_CFG_RENDER_TARGET_PART3 {
   uint32_t                             opcode;
   uint64_t                             clear_color_top_bits;
   uint32_t                             render_target_number;
   uint32_t                             sub_id;
};

static inline void
V3D71_TILE_RENDERING_MODE_CFG_RENDER_TARGET_PART3_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                       const struct V3D71_TILE_RENDERING_MODE_CFG_RENDER_TARGET_PART3 * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
   ...
   cl[ 2] = util_bitpack_uint(values->clear_color_top_bits, 0, 55);

   cl[ 3] = util_bitpack_uint(values->clear_color_top_bits, 0, 55) >> 8;

   cl[ 4] = util_bitpack_uint(values->clear_color_top_bits, 0, 55) >> 16;

   cl[ 5] = util_bitpack_uint(values->clear_color_top_bits, 0, 55) >> 24;

   cl[ 6] = util_bitpack_uint(values->clear_color_top_bits, 0, 55) >> 32;

   cl[ 7] = util_bitpack_uint(values->clear_color_top_bits, 0, 55) >> 40;

   cl[ 8] = util_bitpack_uint(values->clear_color_top_bits, 0, 55) >> 48;

}

#define V3D71_TILE_RENDERING_MODE_CFG_RENDER_TARGET_PART3_length      9
#ifdef __gen_unpack_address
static inline void
V3D71_TILE_RENDERING_MODE_CFG_RENDER_TARGET_PART3_unpack(const uint8_t * restrict cl,
                                                         struct V3D71_TILE_RENDERING_MODE_CFG_RENDER_TARGET_PART3 * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
   values->clear_color_top_bits = __gen_unpack_uint(cl, 16, 71);
   values->render_target_number = __gen_unpack_uint(cl, 11, 13);
   values->sub_id = __gen_unpack_uint(cl, 8, 10);
}
#endif
...
#define V3D71_TILE_COORDINATES_opcode        124
#define V3D71_TILE_COORDINATES_header           \
   .opcode                              =    124

struct V3D71_TILE_COORDINATES {
   uint32_t                             opcode;
...
static inline void
V3D71_TILE_COORDINATES_pack(__gen_user_data *data, uint8_t * restrict cl,
                            const struct V3D71_TILE_COORDINATES * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_TILE_COORDINATES_length          4
#ifdef __gen_unpack_address
static inline void
V3D71_TILE_COORDINATES_unpack(const uint8_t * restrict cl,
                              struct V3D71_TILE_COORDINATES * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D71_MULTICORE_RENDERING_SUPERTILE_CFG_opcode    122
#define V3D71_MULTICORE_RENDERING_SUPERTILE_CFG_header\
   .opcode                              =    122

struct V3D71_MULTICORE_RENDERING_SUPERTILE_CFG {
   uint32_t                             opcode;
...
static inline void
V3D71_MULTICORE_RENDERING_SUPERTILE_CFG_pack(__gen_user_data *data, uint8_t * restrict cl,
                                             const struct V3D71_MULTICORE_RENDERING_SUPERTILE_CFG * restrict values)
{
...
#define V3D71_MULTICORE_RENDERING_SUPERTILE_CFG_length      9
#ifdef __gen_unpack_address
static inline void
V3D71_MULTICORE_RENDERING_SUPERTILE_CFG_unpack(const uint8_t * restrict cl,
                                               struct V3D71_MULTICORE_RENDERING_SUPERTILE_CFG * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D71_MULTICORE_RENDERING_TILE_LIST_SET_BASE_opcode    123
#define V3D71_MULTICORE_RENDERING_TILE_LIST_SET_BASE_header\
   .opcode                              =    123

struct V3D71_MULTICORE_RENDERING_TILE_LIST_SET_BASE {
   uint32_t                             opcode;
   __gen_address_type                   address;
   uint32_t                             tile_list_set_number;
};
...
static inline void
V3D71_MULTICORE_RENDERING_TILE_LIST_SET_BASE_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                  const struct V3D71_MULTICORE_RENDERING_TILE_LIST_SET_BASE * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_MULTICORE_RENDERING_TILE_LIST_SET_BASE_length      5
#ifdef __gen_unpack_address
static inline void
V3D71_MULTICORE_RENDERING_TILE_LIST_SET_BASE_unpack(const uint8_t * restrict cl,
                                                    struct V3D71_MULTICORE_RENDERING_TILE_LIST_SET_BASE * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
   values->address = __gen_unpack_address(cl, 14, 39);
...
#define V3D71_TILE_COORDINATES_IMPLICIT_opcode    125
#define V3D71_TILE_COORDINATES_IMPLICIT_header  \
   .opcode                              =    125

struct V3D71_TILE_COORDINATES_IMPLICIT {
   uint32_t                             opcode;
};

static inline void
V3D71_TILE_COORDINATES_IMPLICIT_pack(__gen_user_data *data, uint8_t * restrict cl,
                                     const struct V3D71_TILE_COORDINATES_IMPLICIT * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);

}

#define V3D71_TILE_COORDINATES_IMPLICIT_length      1
#ifdef __gen_unpack_address
static inline void
V3D71_TILE_COORDINATES_IMPLICIT_unpack(const uint8_t * restrict cl,
                                       struct V3D71_TILE_COORDINATES_IMPLICIT * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D71_TILE_LIST_INITIAL_BLOCK_SIZE_opcode    126
#define V3D71_TILE_LIST_INITIAL_BLOCK_SIZE_header\
   .opcode                              =    126

struct V3D71_TILE_LIST_INITIAL_BLOCK_SIZE {
   uint32_t                             opcode;
...
static inline void
V3D71_TILE_LIST_INITIAL_BLOCK_SIZE_pack(__gen_user_data *data, uint8_t * restrict cl,
                                        const struct V3D71_TILE_LIST_INITIAL_BLOCK_SIZE * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->opcode, 0, 7);
...
#define V3D71_TILE_LIST_INITIAL_BLOCK_SIZE_length      2
#ifdef __gen_unpack_address
static inline void
V3D71_TILE_LIST_INITIAL_BLOCK_SIZE_unpack(const uint8_t * restrict cl,
                                          struct V3D71_TILE_LIST_INITIAL_BLOCK_SIZE * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D71_GL_SHADER_STATE_RECORD_header     \


struct V3D71_GL_SHADER_STATE_RECORD {
   ...
   bool                                 no_prim_pack;
   bool                                 never_defer_fep_depth_writes;
...
static inline void
V3D71_GL_SHADER_STATE_RECORD_pack(__gen_user_data *data, uint8_t * restrict cl,
                                  const struct V3D71_GL_SHADER_STATE_RECORD * restrict values)
{
   ...
   cl[ 2] = util_bitpack_uint(values->turn_off_scoreboard, 0, 0) |
            ...
            util_bitpack_uint(values->never_defer_fep_depth_writes, 4, 4);
   ...
   cl[ 8] = __gen_address_offset(&values->fragment_shader_code_address) |
   ...
   cl[ 9] = __gen_address_offset(&values->fragment_shader_code_address) >> 8;

   cl[10] = __gen_address_offset(&values->fragment_shader_code_address) >> 16;

   cl[11] = __gen_address_offset(&values->fragment_shader_code_address) >> 24;

   __gen_emit_reloc(data, &values->fragment_shader_uniforms_address);
   cl[12] = __gen_address_offset(&values->fragment_shader_uniforms_address);

   cl[13] = __gen_address_offset(&values->fragment_shader_uniforms_address) >> 8;

   cl[14] = __gen_address_offset(&values->fragment_shader_uniforms_address) >> 16;

   cl[15] = __gen_address_offset(&values->fragment_shader_uniforms_address) >> 24;
   ...
   cl[20] = __gen_address_offset(&values->vertex_shader_uniforms_address);

   cl[21] = __gen_address_offset(&values->vertex_shader_uniforms_address) >> 8;

   cl[22] = __gen_address_offset(&values->vertex_shader_uniforms_address) >> 16;

   cl[23] = __gen_address_offset(&values->vertex_shader_uniforms_address) >> 24;

   __gen_emit_reloc(data, &values->coordinate_shader_code_address);
   cl[24] = __gen_address_offset(&values->coordinate_shader_code_address) |
   ...
   cl[25] = __gen_address_offset(&values->coordinate_shader_code_address) >> 8;

   cl[26] = __gen_address_offset(&values->coordinate_shader_code_address) >> 16;

   cl[27] = __gen_address_offset(&values->coordinate_shader_code_address) >> 24;

   __gen_emit_reloc(data, &values->coordinate_shader_uniforms_address);
   cl[28] = __gen_address_offset(&values->coordinate_shader_uniforms_address);

   cl[29] = __gen_address_offset(&values->coordinate_shader_uniforms_address) >> 8;

   cl[30] = __gen_address_offset(&values->coordinate_shader_uniforms_address) >> 16;

   cl[31] = __gen_address_offset(&values->coordinate_shader_uniforms_address) >> 24;

}

#define V3D71_GL_SHADER_STATE_RECORD_length     32
#ifdef __gen_unpack_address
static inline void
V3D71_GL_SHADER_STATE_RECORD_unpack(const uint8_t * restrict cl,
                                    struct V3D71_GL_SHADER_STATE_RECORD * restrict values)
{
   ...
   values->never_defer_fep_depth_writes = __gen_unpack_uint(cl, 20, 20);
   ...
   values->fragment_shader_code_address = __gen_unpack_address(cl, 67, 95);
   values->fragment_shader_4_way_threadable = __gen_unpack_uint(cl, 64, 64);
   values->fragment_shader_start_in_final_thread_section = __gen_unpack_uint(cl, 65, 65);
   values->fragment_shader_propagate_nans = __gen_unpack_uint(cl, 66, 66);
   values->fragment_shader_uniforms_address = __gen_unpack_address(cl, 96, 127);
   values->vertex_shader_code_address = __gen_unpack_address(cl, 131, 159);
   values->vertex_shader_4_way_threadable = __gen_unpack_uint(cl, 128, 128);
   values->vertex_shader_start_in_final_thread_section = __gen_unpack_uint(cl, 129, 129);
   values->vertex_shader_propagate_nans = __gen_unpack_uint(cl, 130, 130);
   values->vertex_shader_uniforms_address = __gen_unpack_address(cl, 160, 191);
   values->coordinate_shader_code_address = __gen_unpack_address(cl, 195, 223);
   values->coordinate_shader_4_way_threadable = __gen_unpack_uint(cl, 192, 192);
   values->coordinate_shader_start_in_final_thread_section = __gen_unpack_uint(cl, 193, 193);
   values->coordinate_shader_propagate_nans = __gen_unpack_uint(cl, 194, 194);
   values->coordinate_shader_uniforms_address = __gen_unpack_address(cl, 224, 255);
}
#endif


#define V3D71_GL_SHADER_STATE_RECORD_DRAW_INDEX_header\


struct V3D71_GL_SHADER_STATE_RECORD_DRAW_INDEX {
   bool                                 point_size_in_shaded_vertex_data;
   bool                                 enable_clipping;
   bool                                 vertex_id_read_by_coordinate_shader;
   bool                                 instance_id_read_by_coordinate_shader;
...
static inline void
V3D71_GL_SHADER_STATE_RECORD_DRAW_INDEX_pack(__gen_user_data *data, uint8_t * restrict cl,
                                             const struct V3D71_GL_SHADER_STATE_RECORD_DRAW_INDEX * restrict values)
{
   assert(values->min_coord_shader_input_segments_required_in_play >= 1);
   assert(values->min_vertex_shader_input_segments_required_in_play >= 1);
   cl[ 0] = util_bitpack_uint(values->point_size_in_shaded_vertex_data, 0, 0) |
            ...
            util_bitpack_uint(values->instance_id_read_by_coordinate_shader, 3, 3) |
            util_bitpack_uint(values->base_instance_id_read_by_coordinate_shader, 4, 4) |
            util_bitpack_uint(values->cs_basevertex, 5, 5) |
            util_bitpack_uint(values->cs_drawindex, 6, 6) |
            util_bitpack_uint(values->vertex_id_read_by_vertex_shader, 7, 7);

   cl[ 1] = util_bitpack_uint(values->instance_id_read_by_vertex_shader, 0, 0) |
            util_bitpack_uint(values->base_instance_id_read_by_vertex_shader, 1, 1) |
            util_bitpack_uint(values->vs_basevertex, 2, 2) |
            util_bitpack_uint(values->vs_drawindex, 3, 3) |
            util_bitpack_uint(values->fragment_shader_does_z_writes, 4, 4) |
            util_bitpack_uint(values->turn_off_early_z_test, 5, 5) |
            util_bitpack_uint(values->fragment_shader_uses_real_pixel_centre_w_in_addition_to_centroid_w2, 7, 7);

   cl[ 2] = util_bitpack_uint(values->enable_sample_rate_shading, 0, 0) |
            util_bitpack_uint(values->any_shader_reads_hardware_written_primitive_id, 1, 1) |
            util_bitpack_uint(values->insert_primitive_id_as_first_varying_to_fragment_shader, 2, 2) |
            util_bitpack_uint(values->turn_off_scoreboard, 3, 3) |
            util_bitpack_uint(values->do_scoreboard_wait_on_first_thread_switch, 4, 4) |
            util_bitpack_uint(values->disable_implicit_point_line_varyings, 5, 5) |
            util_bitpack_uint(values->no_prim_pack, 6, 6) |
            util_bitpack_uint(values->never_defer_fep_depth_writes, 7, 7);
...
#define V3D71_GL_SHADER_STATE_RECORD_DRAW_INDEX_length     32
#ifdef __gen_unpack_address
static inline void
V3D71_GL_SHADER_STATE_RECORD_DRAW_INDEX_unpack(const uint8_t * restrict cl,
                                               struct V3D71_GL_SHADER_STATE_RECORD_DRAW_INDEX * restrict values)
{
   values->point_size_in_shaded_vertex_data = __gen_unpack_uint(cl, 0, 0);
   values->enable_clipping = __gen_unpack_uint(cl, 1, 1);
   values->vertex_id_read_by_coordinate_shader = __gen_unpack_uint(cl, 2, 2);
   values->instance_id_read_by_coordinate_shader = __gen_unpack_uint(cl, 3, 3);
   values->base_instance_id_read_by_coordinate_shader = __gen_unpack_uint(cl, 4, 4);
   values->cs_basevertex = __gen_unpack_uint(cl, 5, 5);
   values->cs_drawindex = __gen_unpack_uint(cl, 6, 6);
   values->vertex_id_read_by_vertex_shader = __gen_unpack_uint(cl, 7, 7);
   values->instance_id_read_by_vertex_shader = __gen_unpack_uint(cl, 8, 8);
   values->base_instance_id_read_by_vertex_shader = __gen_unpack_uint(cl, 9, 9);
   values->vs_basevertex = __gen_unpack_uint(cl, 10, 10);
   values->vs_drawindex = __gen_unpack_uint(cl, 11, 11);
   values->fragment_shader_does_z_writes = __gen_unpack_uint(cl, 12, 12);
   values->turn_off_early_z_test = __gen_unpack_uint(cl, 13, 13);
   values->fragment_shader_uses_real_pixel_centre_w_in_addition_to_centroid_w2 = __gen_unpack_uint(cl, 15, 15);
   values->enable_sample_rate_shading = __gen_unpack_uint(cl, 16, 16);
   values->any_shader_reads_hardware_written_primitive_id = __gen_unpack_uint(cl, 17, 17);
   values->insert_primitive_id_as_first_varying_to_fragment_shader = __gen_unpack_uint(cl, 18, 18);
   values->turn_off_scoreboard = __gen_unpack_uint(cl, 19, 19);
   values->do_scoreboard_wait_on_first_thread_switch = __gen_unpack_uint(cl, 20, 20);
   values->disable_implicit_point_line_varyings = __gen_unpack_uint(cl, 21, 21);
   values->no_prim_pack = __gen_unpack_uint(cl, 22, 22);
   values->never_defer_fep_depth_writes = __gen_unpack_uint(cl, 23, 23);
   values->number_of_varyings_in_fragment_shader = __gen_unpack_uint(cl, 24, 31);
   values->coordinate_shader_output_vpm_segment_size = __gen_unpack_uint(cl, 32, 35);
   values->min_coord_shader_output_segments_required_in_play_in_addition_to_vcm_cache_size = __gen_unpack_uint(cl, 36, 39);
   values->coordinate_shader_input_vpm_segment_size = __gen_unpack_uint(cl, 40, 43);
...
#define V3D71_GEOMETRY_SHADER_STATE_RECORD_header\
...
static inline void
V3D71_GEOMETRY_SHADER_STATE_RECORD_pack(__gen_user_data *data, uint8_t * restrict cl,
                                        const struct V3D71_GEOMETRY_SHADER_STATE_RECORD * restrict values)
{
...
#define V3D71_GEOMETRY_SHADER_STATE_RECORD_length     16
#ifdef __gen_unpack_address
static inline void
V3D71_GEOMETRY_SHADER_STATE_RECORD_unpack(const uint8_t * restrict cl,
                                          struct V3D71_GEOMETRY_SHADER_STATE_RECORD * restrict values)
{
...
#define V3D71_TESSELLATION_SHADER_STATE_RECORD_header\


struct V3D71_TESSELLATION_SHADER_STATE_RECORD {
...
static inline void
V3D71_TESSELLATION_SHADER_STATE_RECORD_pack(__gen_user_data *data, uint8_t * restrict cl,
                                            const struct V3D71_TESSELLATION_SHADER_STATE_RECORD * restrict values)
{
...
#define V3D71_TESSELLATION_SHADER_STATE_RECORD_length     32
#ifdef __gen_unpack_address
static inline void
V3D71_TESSELLATION_SHADER_STATE_RECORD_unpack(const uint8_t * restrict cl,
                                              struct V3D71_TESSELLATION_SHADER_STATE_RECORD * restrict values)
{
...
#define V3D71_TESSELLATION_GEOMETRY_COMMON_PARAMS_header\


struct V3D71_TESSELLATION_GEOMETRY_COMMON_PARAMS {
...
static inline void
V3D71_TESSELLATION_GEOMETRY_COMMON_PARAMS_pack(__gen_user_data *data, uint8_t * restrict cl,
                                               const struct V3D71_TESSELLATION_GEOMETRY_COMMON_PARAMS * restrict values)
{
...
#define V3D71_TESSELLATION_GEOMETRY_COMMON_PARAMS_length      4
#ifdef __gen_unpack_address
static inline void
V3D71_TESSELLATION_GEOMETRY_COMMON_PARAMS_unpack(const uint8_t * restrict cl,
                                                 struct V3D71_TESSELLATION_GEOMETRY_COMMON_PARAMS * restrict values)
{
...
#define V3D71_TESSELLATION_GEOMETRY_SHADER_PARAMS_header\


struct V3D71_TESSELLATION_GEOMETRY_SHADER_PARAMS {
   enum V3D71_TCS_flush_mode            tcs_batch_flush_mode;
   uint32_t                             per_patch_data_column_depth;
   uint32_t                             tcs_output_segment_size_in_sectors;
   enum V3D71_Pack_Mode                 tcs_output_segment_pack_mode;
   uint32_t                             tes_output_segment_size_in_sectors;
   enum V3D71_Pack_Mode                 tes_output_segment_pack_mode;
   uint32_t                             gs_output_segment_size_in_sectors;
   enum V3D71_Pack_Mode                 gs_output_segment_pack_mode;
...
static inline void
V3D71_TESSELLATION_GEOMETRY_SHADER_PARAMS_pack(__gen_user_data *data, uint8_t * restrict cl,
                                               const struct V3D71_TESSELLATION_GEOMETRY_SHADER_PARAMS * restrict values)
{
...
#define V3D71_TESSELLATION_GEOMETRY_SHADER_PARAMS_length      8
#ifdef __gen_unpack_address
static inline void
V3D71_TESSELLATION_GEOMETRY_SHADER_PARAMS_unpack(const uint8_t * restrict cl,
                                                 struct V3D71_TESSELLATION_GEOMETRY_SHADER_PARAMS * restrict values)
{
...
#define V3D71_GL_SHADER_STATE_ATTRIBUTE_RECORD_header\


struct V3D71_GL_SHADER_STATE_ATTRIBUTE_RECORD {
   __gen_address_type                   address;
   uint32_t                             vec_size;
   uint32_t                             type;
...
static inline void
V3D71_GL_SHADER_STATE_ATTRIBUTE_RECORD_pack(__gen_user_data *data, uint8_t * restrict cl,
                                            const struct V3D71_GL_SHADER_STATE_ATTRIBUTE_RECORD * restrict values)
{
   __gen_emit_reloc(data, &values->address);
   cl[ 0] = __gen_address_offset(&values->address);
...
#define V3D71_GL_SHADER_STATE_ATTRIBUTE_RECORD_length     16
#ifdef __gen_unpack_address
static inline void
V3D71_GL_SHADER_STATE_ATTRIBUTE_RECORD_unpack(const uint8_t * restrict cl,
                                              struct V3D71_GL_SHADER_STATE_ATTRIBUTE_RECORD * restrict values)
{
   values->address = __gen_unpack_address(cl, 0, 31);
...
#define V3D71_VPM_GENERIC_BLOCK_WRITE_SETUP_header\
   .id                                  =      0,  \
   .id0                                 =      0

struct V3D71_VPM_GENERIC_BLOCK_WRITE_SETUP {
   uint32_t                             id;
   uint32_t                             id0;
   bool                                 horiz;
   bool                                 laned;
...
static inline void
V3D71_VPM_GENERIC_BLOCK_WRITE_SETUP_pack(__gen_user_data *data, uint8_t * restrict cl,
                                         const struct V3D71_VPM_GENERIC_BLOCK_WRITE_SETUP * restrict values)
{
...
#define V3D71_VPM_GENERIC_BLOCK_WRITE_SETUP_length      4
#ifdef __gen_unpack_address
static inline void
V3D71_VPM_GENERIC_BLOCK_WRITE_SETUP_unpack(const uint8_t * restrict cl,
                                           struct V3D71_VPM_GENERIC_BLOCK_WRITE_SETUP * restrict values)
{
...
#define V3D71_VPM_GENERIC_BLOCK_READ_SETUP_header\
   .id                                  =      1

struct V3D71_VPM_GENERIC_BLOCK_READ_SETUP {
   uint32_t                             id;
   bool                                 horiz;
   bool                                 laned;
   bool                                 segs;
...
static inline void
V3D71_VPM_GENERIC_BLOCK_READ_SETUP_pack(__gen_user_data *data, uint8_t * restrict cl,
                                        const struct V3D71_VPM_GENERIC_BLOCK_READ_SETUP * restrict values)
{
   cl[ 0] = util_bitpack_uint(values->addr, 0, 12);
...
#define V3D71_VPM_GENERIC_BLOCK_READ_SETUP_length      4
#ifdef __gen_unpack_address
static inline void
V3D71_VPM_GENERIC_BLOCK_READ_SETUP_unpack(const uint8_t * restrict cl,
                                          struct V3D71_VPM_GENERIC_BLOCK_READ_SETUP * restrict values)
{
   values->id = __gen_unpack_uint(cl, 30, 31);
...
#define V3D71_TMU_CONFIG_PARAMETER_0_header     \


struct V3D71_TMU_CONFIG_PARAMETER_0 {
   __gen_address_type                   texture_state_address;
   uint32_t                             return_words_of_texture_data;
};

static inline void
V3D71_TMU_CONFIG_PARAMETER_0_pack(__gen_user_data *data, uint8_t * restrict cl,
                                  const struct V3D71_TMU_CONFIG_PARAMETER_0 * restrict values)
{
...
#define V3D71_TMU_CONFIG_PARAMETER_0_length      4
#ifdef __gen_unpack_address
static inline void
V3D71_TMU_CONFIG_PARAMETER_0_unpack(const uint8_t * restrict cl,
                                    struct V3D71_TMU_CONFIG_PARAMETER_0 * restrict values)
{
...
#define V3D71_TMU_CONFIG_PARAMETER_1_header     \


struct V3D71_TMU_CONFIG_PARAMETER_1 {
...
static inline void
V3D71_TMU_CONFIG_PARAMETER_1_pack(__gen_user_data *data, uint8_t * restrict cl,
                                  const struct V3D71_TMU_CONFIG_PARAMETER_1 * restrict values)
{
...
#define V3D71_TMU_CONFIG_PARAMETER_1_length      4
#ifdef __gen_unpack_address
static inline void
V3D71_TMU_CONFIG_PARAMETER_1_unpack(const uint8_t * restrict cl,
                                    struct V3D71_TMU_CONFIG_PARAMETER_1 * restrict values)
{
...
#define V3D71_TMU_CONFIG_PARAMETER_2_header     \


struct V3D71_TMU_CONFIG_PARAMETER_2 {
   uint32_t                             pad;
   bool                                 write_conversion;
   bool                                 dim_query;
   bool                                 lod_query;
   enum V3D71_TMU_Op                    op;
   int32_t                              offset_r;
   int32_t                              offset_t;
   int32_t                              offset_s;
   bool                                 gather_mode;
...
static inline void
V3D71_TMU_CONFIG_PARAMETER_2_pack(__gen_user_data *data, uint8_t * restrict cl,
                                  const struct V3D71_TMU_CONFIG_PARAMETER_2 * restrict values)
{
   ...
   cl[ 3] = util_bitpack_uint(values->pad, 3, 7) |
            util_bitpack_uint(values->write_conversion, 2, 2) |
            util_bitpack_uint(values->dim_query, 1, 1) |
            util_bitpack_uint(values->lod_query, 0, 0);

}

#define V3D71_TMU_CONFIG_PARAMETER_2_length      4
#ifdef __gen_unpack_address
static inline void
V3D71_TMU_CONFIG_PARAMETER_2_unpack(const uint8_t * restrict cl,
                                    struct V3D71_TMU_CONFIG_PARAMETER_2 * restrict values)
{
   values->pad = __gen_unpack_uint(cl, 27, 31);
   values->write_conversion = __gen_unpack_uint(cl, 26, 26);
   values->dim_query = __gen_unpack_uint(cl, 25, 25);
...
#define V3D71_TEXTURE_SHADER_STATE_header       \


struct V3D71_TEXTURE_SHADER_STATE {
   uint32_t                             pad;
   uint32_t                             texture_base_pointer_cr;
   uint32_t                             texture_base_pointer_cb;
   uint32_t                             chroma_offset_y;
   uint32_t                             chroma_offset_x;
...
#define TRANSFER_FUNC_NONE                       0
#define TRANSFER_FUNC_SRGB                       1
#define TRANSFER_FUNC_PQ                         2
#define TRANSFER_FUNC_HLG                        3
#define TRANSFER_FUNC_PQ_BT1886                  4
#define TRANSFER_FUNC_HLG_BT1886                 5
   bool                                 flip_texture_y_axis;
   bool                                 flip_texture_x_axis;
};

static inline void
V3D71_TEXTURE_SHADER_STATE_pack(__gen_user_data *data, uint8_t * restrict cl,
                                const struct V3D71_TEXTURE_SHADER_STATE * restrict values)
{
   __gen_emit_reloc(data, &values->texture_base_pointer);
   cl[ 0] = __gen_address_offset(&values->texture_base_pointer) |
            util_bitpack_uint(values->reverse, 5, 5) |
            util_bitpack_uint(values->transfer_func, 2, 4) |
   ...
   cl[ 4] = util_bitpack_uint(values->array_stride_64_byte_aligned, 1, 24) |
            util_bitpack_uint(values->r_b_swap, 0, 0);

   cl[ 5] = util_bitpack_uint(values->array_stride_64_byte_aligned, 1, 24) >> 8;

   cl[ 6] = util_bitpack_uint(values->array_stride_64_byte_aligned, 1, 24) >> 16;

   cl[ 7] = util_bitpack_uint(values->image_width, 2, 15) |
            util_bitpack_uint(values->array_stride_64_byte_aligned, 1, 24) >> 24;
   ...
   cl[17] = util_bitpack_uint(values->texture_base_pointer_cb, 2, 27) |
            util_bitpack_uint(values->chroma_offset_y, 1, 1) |
            util_bitpack_uint(values->chroma_offset_x, 0, 0);

   cl[18] = util_bitpack_uint(values->texture_base_pointer_cb, 2, 27) >> 8;

   cl[19] = util_bitpack_uint(values->texture_base_pointer_cb, 2, 27) >> 16;

   cl[20] = util_bitpack_uint(values->texture_base_pointer_cr, 4, 29) |
            util_bitpack_uint(values->texture_base_pointer_cb, 2, 27) >> 24;

   cl[21] = util_bitpack_uint(values->texture_base_pointer_cr, 4, 29) >> 8;

   cl[22] = util_bitpack_uint(values->texture_base_pointer_cr, 4, 29) >> 16;

   cl[23] = util_bitpack_uint(values->pad, 6, 7) |
            util_bitpack_uint(values->texture_base_pointer_cr, 4, 29) >> 24;

}

#define V3D71_TEXTURE_SHADER_STATE_length     24
#ifdef __gen_unpack_address
static inline void
V3D71_TEXTURE_SHADER_STATE_unpack(const uint8_t * restrict cl,
                                  struct V3D71_TEXTURE_SHADER_STATE * restrict values)
{
   values->pad = __gen_unpack_uint(cl, 190, 191);
   values->texture_base_pointer_cr = __gen_unpack_uint(cl, 164, 189);
   values->texture_base_pointer_cb = __gen_unpack_uint(cl, 138, 163);
   values->chroma_offset_y = __gen_unpack_uint(cl, 137, 137);
   values->chroma_offset_x = __gen_unpack_uint(cl, 136, 136);
   ...
   values->array_stride_64_byte_aligned = __gen_unpack_uint(cl, 33, 56);
   values->r_b_swap = __gen_unpack_uint(cl, 32, 32);
   values->texture_base_pointer = __gen_unpack_address(cl, 0, 31);
   values->reverse = __gen_unpack_uint(cl, 5, 5);
   values->transfer_func = __gen_unpack_uint(cl, 2, 4);
...
#define V3D71_SAMPLER_STATE_header              \


struct V3D71_SAMPLER_STATE {
   ...
   enum V3D71_Border_Color_Mode         border_color_mode;
   bool                                 wrap_i_border;
   enum V3D71_Wrap_Mode                 wrap_r;
   enum V3D71_Wrap_Mode                 wrap_t;
   enum V3D71_Wrap_Mode                 wrap_s;
   float                                fixed_bias;
   float                                max_level_of_detail;
   float                                min_level_of_detail;
   bool                                 srgb_disable;
   enum V3D71_Compare_Function          depth_compare_function;
...
static inline void
V3D71_SAMPLER_STATE_pack(__gen_user_data *data, uint8_t * restrict cl,
                         const struct V3D71_SAMPLER_STATE * restrict values)
{
...
#define V3D71_SAMPLER_STATE_length            24
#ifdef __gen_unpack_address
static inline void
V3D71_SAMPLER_STATE_unpack(const uint8_t * restrict cl,
                           struct V3D71_SAMPLER_STATE * restrict values)
{
